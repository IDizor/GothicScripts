...
instance PC_ItPo_Mana_04x5(C_Info)
{
	...
	permanent = TRUE;
	description = "„иста€ мана 5 шт. (15 эссенций маны, 5 луговых горцев)";
};
...
instance PC_ItPo_Health_04x5(C_Info)
{
	...
	permanent = TRUE;
	description = "„истое здоровье 5 шт. (15 лечебных эссенций, 5 луговых горцев)";
};
...
instance PC_ItPo_MegaDrink(C_Info)
{
	...
	permanent = TRUE;
	description = "Ёмбарла фиргасто (10 драконьих €иц, 1 черный жемчуг, 1 сера)";
};

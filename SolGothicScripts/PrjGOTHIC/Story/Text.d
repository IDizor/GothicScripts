...
const string NAME_SPL_TeleportSeaport = "Телепорт в Хоринис";
...
const string PRINT_FreeByQuest = " (0 LP по заданию)";
...
const string PRINT_Learn1H = "Улучшено: Одноручник";
const string PRINT_Learn1H_and_2H = "Улучшено: Одноручник и Двуручник";
const string PRINT_Learn2H = "Улучшено: Двуручник";
const string PRINT_Learn2H_and_1H = "Улучшено: Двуручник и Одноручник";
const string PRINT_LearnBow = "Улучшено: Лучник";
const string PRINT_LearnBow_and_Crossbow = "Улучшено: Лучник и Арбалетчик";
const string PRINT_LearnCrossbow = "Улучшено: Арбалетчик";
const string PRINT_LearnCrossbow_and_Bow = "Улучшено: Арбалетчик и Лучник";
const string PRINT_LearnPicklock = "Изучено: Владение отмычками";
const string PRINT_LearnSneak = "Изучено: Способность красться";
const string PRINT_LearnAcrobat = "Изучено: Акробатика";
const string PRINT_Addon_AcrobatBonus = "Улучшение акробатики!";
const string PRINT_LearnPickpocket = "Изучено: Карманное воровство";
const string PRINT_Beliarshitpoints_MAX = "Здоровье -";
const string PRINT_LearnSmith = "Изучено: Иизготовление оружия";
const string PRINT_LearnRunes = "Изучено: Создание рун";
const string PRINT_LearnAlchemy = "Изучено: Приготовление зелий";
const string PRINT_LearnAlchemyInnosEye = "Изучено: Восстановление Глаза Инноса";
...
const string PRINT_LearnWispDetector = "Блуждающий огонек обучился новым способностям";
...
const string PRINT_LearnSTR10 = "Сила + 10";
const string PRINT_LearnDEX1 = "Ловкость + 1";
const string PRINT_LearnDEX5 = "Ловкость + 5";
const string PRINT_LearnDEX10 = "Ловкость + 10";
const string PRINT_LearnMANA1 = "Мана + 1"; // не используется. смотри функцию B_ManaPlusText()
const string PRINT_LearnMANA5 = "Мана + 5"; // не используется. смотри функцию B_ManaPlusText()
...
const string PRINT_ProdItemsMissing = "Недостаточно ресурсов!";
...
const string PRINT_ADDON_KNOWSBF = "Изучено - секрет из жала";
const string PRINT_ADDON_HACKCHANCE = "Добыча золота: +";
...
const string PRINT_Mandibles = "Этот секрет больше не дает никакого эффекта.";

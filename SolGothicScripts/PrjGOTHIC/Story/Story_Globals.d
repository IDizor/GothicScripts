...
const int T_MED = 90;
const int T_LOW = 60;
const int ManaTeachersLimitMultiplier = 10;
const int ManaUpFor1LP_Regular = 2;
const int ManaUpFor1LP_Mage = 10;
const int MushroomManaBonusPeriod = 50;
const int MushroomManaBonus = 30;
const int VatrasStoneplatesManaMultiplier = 1;
const int ManaAstronomyBonus = 2;
const int ManaLittlePotion = 3;
const int KlosterGuildManaBonus = 200;

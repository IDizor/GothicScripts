...
func void DIA_Addon_Paul_HunoArbeit_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Paul_HunoArbeit_03_01");	//Я ничего не знаю - честно! Мне нужно идти!
...
{
	AI_Output(other,self,"DIA_Addon_Paul_MaulPaul_15_00");	//Пол, скажи мне, что тебе известно, или я размажу тебя по этой стенке!
	AI_Output(self,other,"DIA_Addon_Paul_MaulPaul_03_01");	//Ты не можешь избить меня просто потому, что ты работаешь на босса.
	AI_Output(other,self,"DIA_Addon_Paul_MaulPaul_15_02");	//Могу!
	AI_Output(self,other,"DIA_Addon_Paul_MaulPaul_03_03");	//Не говори глупостей!
	AI_Output(other,self,"DIA_Addon_Paul_MaulPaul_15_04");	//Пол...
	AI_Output(self,other,"DIA_Addon_Paul_MaulPaul_03_05");	//Я знаю только, что у Хуно с Эстебаном какие-то разногласия.
	AI_Output(self,other,"DIA_Addon_Paul_MaulPaul_03_06");	//При мне он постоянно ругается на Эстебана. Что тот испортил ему дело и все такое...

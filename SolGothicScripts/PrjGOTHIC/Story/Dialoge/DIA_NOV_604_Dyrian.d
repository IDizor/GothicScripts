...
{
	AI_Output(self,other,"DIA_Dyrian_Hello_13_00");	//Что тебе нужно?
};
...
{
	AI_Output(self,other,"DIA_Dyrian_HelloAgain_13_00");	//Спасибо! Ты спас меня!
	AI_Output(self,other,"DIA_Dyrian_HelloAgain_13_01");	//Ох - прошу простить меня, Мастер. Я не хотел показаться невежливым.
	AI_Output(self,other,"DIA_Dyrian_HelloAgain_13_02");	//Я благодарю тебя за то, что мне позволено остаться в монастыре. Моя жизнь теперь переменится...
...
func void DIA_Dyrian_Kneipe_Gold()
{
	...
	AI_Output(self,other,"DIA_Dyrian_Kneipe_Gold_13_01");	//5 золотых? Ты даешь мне 5 золотых в качестве компенсации за то, что лишил меня смысла моей жизни?

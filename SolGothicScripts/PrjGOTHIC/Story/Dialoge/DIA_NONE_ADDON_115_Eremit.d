...
func void DIA_Addon_Eremit_Teach_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Eremit_Add_04_26");	//Но свои я тебе не отдам! Сам ищи себе таблички!
	};
...
{
	AI_Output(self,other,"DIA_Addon_Eremit_Add_04_24");	//Ну вот... Сначала ты меня обнадежил, а потом...
	Info_ClearChoices(DIA_Addon_Eremit_Klamotten);
};
...
func void DIA_Addon_Eremit_PERM_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Eremit_Add_04_09");	//Я все сделал сам. Дом, оружие, инструменты - все.

...
func void DIA_Addon_Pardos_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Pardos_Hi_03_01");	//Я устал... Я совершенно изможден. Скажи, сейчас солнечный день или ясная ночь, и тысячи звезд мерцают на небосклоне?
...
func void DIA_Addon_Pardos_save_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Pardos_save_03_01");	//Спасибо. Спасибо за добрые слова.
};

...
func void DIA_Meldor_Lehmar_Info()
{
	...
	AI_Output(self,other,"DIA_Meldor_Lehmar_07_01");	//Нет. Но прямо через улицу находится дом Лемара, ростовщика.
...
func void DIA_Meldor_InsOV_Info()
{
	...
	AI_Output(self,other,"DIA_Meldor_InsOV_07_01");	//Да, конечно. А я собирался сесть на корабль и нанести визит королю.
...
func void DIA_Meldor_Smoke_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Meldor_Smoke_07_01");	//Нет, понятия не имею.
	}
	else
	{

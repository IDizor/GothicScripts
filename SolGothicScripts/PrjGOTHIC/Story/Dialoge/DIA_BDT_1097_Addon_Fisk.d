...
func void DIA_Addon_Fisk_GivePaket_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Fisk_GivePaket_12_01");	//Замечательно! А что с Хуаном?
...
func void DIA_Addon_Fisk_PaketOpen_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Fisk_PaketOpen_12_01");	//Ну конечно! Тебе не терпелось узнать, что внутри, не так ли?
...
func void DIA_Addon_Fisk_Inspektor_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Fisk_Inspektor_12_03");	//Хорошо. Ты прав. Но я надеюсь, что ты понимаешь, почему я тебе об этом не сказал.

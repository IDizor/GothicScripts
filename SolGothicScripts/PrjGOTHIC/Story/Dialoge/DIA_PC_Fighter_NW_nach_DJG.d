...
func void DIA_GornNW_nach_DJG_AllDragonsDead_Info()
{
	...
	AI_Output(self,other,"DIA_GornNW_nach_DJG_AllDragonsDead_12_03");	//Ладно. Все как всегда. Дай мне знать, если тебе понадобится мой топор.
};
...
func void DIA_GornNW_nach_DJG_KnowWhereEnemy_Info()
{
	...
	AI_Output(self,other,"DIA_GornNW_nach_DJG_KnowWhereEnemy_12_03");	//Конечно. Всегда готов. Просто скажи, что нужно делать.

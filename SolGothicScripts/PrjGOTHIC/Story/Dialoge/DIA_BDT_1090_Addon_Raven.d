...
func void DIA_Addon_Raven_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Raven_Add_10_03");	//Что ж, раз ты так спешил, то и смерть твоя будет быстрой.
...
func void DIA_Addon_Raven_Hi_Attack()
{
	...
	AI_Output(self,other,"DIA_Addon_Raven_Add_10_12");	//Ты так торопишься умереть? Ну, раз ты настаиваешь...
	AI_StopProcessInfos(self);

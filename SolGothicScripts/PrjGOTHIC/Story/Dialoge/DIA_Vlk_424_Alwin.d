...
func void DIA_Alwin_Sheep_Info()
{
	...
	AI_Output(self,other,"DIA_Alwin_Sheep_12_01");	//Единственная овца, что принадлежит мне, отзывается на имя Люси. Это моя жена - Люси.
...
func void DIA_Alwin_Endlos_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Alwin_Endlos_12_02");	//Овцы едят и становятся все толще и толще. Прямо как моя жена. ХА-ХА-ХА
	}
	else if(Kapitel == 3)
	{

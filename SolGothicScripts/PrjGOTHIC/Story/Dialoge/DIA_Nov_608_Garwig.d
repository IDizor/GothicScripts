...
func void DIA_Garwig_THIEF_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Garwig_THIEF_06_00");	//Вор! Ты опозорил не только себя и меня, но и весь монастырь!
		AI_Output(self,other,"DIA_Garwig_THIEF_06_01");	//Ты поплатишься за это святотатство. И, заклинаю Инносом - ВЕРНИ МНЕ ЭТОТ МОЛОТ!
	}
	else
	{
		AI_Output(self,other,"DIA_Garwig_THIEF_06_02");	//Молот исчез! Как это могло произойти?

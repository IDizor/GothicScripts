...
func void DIA_Bartok_Bosper_Info()
{
	...
	AI_Output(self,other,"DIA_Bartok_Bosper_04_05");	//У Боспера недавно украли лук. Прямо средь бела дня.
...
func void DIA_Bartok_HuntNOW_Info()
{
	...
	AI_Output(self,other,"DIA_Bartok_HuntNOW_GO_04_02");	//Даже больше, чем хотелось бы...
	Bartok_Los = TRUE;
	AI_StopProcessInfos(self);
...
func void DIA_Bartok_ImWald_Weiter()
{
	...
	AI_Output(self,other,"DIA_Bartok_ImWald_Weiter_04_01");	//Хорошо. Будем надеяться, что нам повезет...

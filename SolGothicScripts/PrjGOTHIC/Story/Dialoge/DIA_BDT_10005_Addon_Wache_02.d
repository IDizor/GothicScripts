...
func void DIA_Addon_Wache_02_Attentat_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Wache_02_Attentat_13_01");	//Что я знаю о нем? Я сломал этому парню ноги.
	AI_Output(self,other,"DIA_Addon_Wache_02_Attentat_13_02");	//И я сделаю это с каждым, кто попробует напасть на Эстебана...
};

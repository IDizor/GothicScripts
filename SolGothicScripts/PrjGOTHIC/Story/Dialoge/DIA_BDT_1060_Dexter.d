...
func void DIA_Addon_Dexter_missingPeople_Wo()
{
	...
	AI_Output(self,other,"DIA_Addon_Dexter_missingPeople_Wo_09_01");	//Нет-нет, они далеко на северо-востоке. Тебе туда не добраться.
...
func void DIA_Addon_Dexter_missingPeople_Raven()
{
	...
	AI_Output(self,other,"DIA_Addon_Dexter_missingPeople_Raven_09_01");	//Да что тебе известно? Ты не знаешь его, как я знаю.
	AI_Output(self,other,"DIA_Addon_Dexter_missingPeople_Raven_09_02");	//Тогда он действительно был жалкой свиньей, но теперь...
	...
	AI_Output(self,other,"DIA_Addon_Dexter_missingPeople_Raven_09_04");	//Если слишком долго смотреть ему в глаза, его взгляд пронзит тебя, как когти хищника.
	...
	AI_Output(self,other,"DIA_Addon_Dexter_missingPeople_Raven_09_06");	//Здесь тебя ждет лишь верная смерть.
...
func void DIA_Addon_Dexter_Boss_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Dexter_Boss_09_01");	//Тебе, наверняка, не терпится это узнать? Понимаю.
	AI_Output(self,other,"DIA_Addon_Dexter_Boss_09_02");	//Не вижу ни одной причины, по которой я должен тебе это сказать.
};
...
func void DIA_Dexter_Vor_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Dexter_Vor_09_01");	//Ты мог бы попробовать силой заставить меня говорить...
	AI_Output(self,other,"DIA_Addon_Dexter_Vor_09_02");	//Думаю, тебе лучше уйти.

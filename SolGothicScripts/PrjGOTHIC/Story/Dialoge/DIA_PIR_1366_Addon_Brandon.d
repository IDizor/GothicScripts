...
func void DIA_Addon_Brandon_AnyNews_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Brandon_AnyNews_04_06");	//Погоди секунду...
		AI_PlayAni(self,"T_SEARCH");
		AI_Output(self,other,"DIA_Addon_Brandon_AnyNews_04_07");	//Насколько я вижу, нет! Все по-старому
	};
};
...
func void DIA_Addon_Brandon_WannaLearn_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Brandon_WannaLearn_04_03");	//Неплохо, сынок! Угадал с первой попытки.
...
func void DIA_Addon_Brandon_Anheuern_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Brandon_Anheuern_04_03");	//Наконец-то здесь хоть что-нибудь происходит!

...
func void DIA_Lee_PETZMASTER_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Lee_PETZMASTER_04_00");	//Какого дьявола тебя позволили пустить сюда? Это ты новичок, от которого одни проблемы?
...
{
	AI_Output(self,other,"DIA_Lee_Hallo_04_00");	//Какого дьявола ТЕБЯ позволили пустить сюда? Что ты делаешь здесь? Я думал, ты мертв!
...
func void DIA_Lee_Paladine_Info()
{
	...
	AI_Output(self,other,"DIA_Lee_Paladine_04_01");	//Какие у тебя могут быть дела с паладинами?
	...
	AI_Output(other,self,"DIA_Lee_Paladine_15_04");	//Ксардас дал мне задание. Он хочет, чтобы я заполучил мощный амулет, Глаз Инноса.
...
func void DIA_Lee_KeinSld_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Lee_KeinSld_04_01");	//Ты постригся в монастырь? Я всего ожидал, только не этого.
	};
...
func void DIA_Lee_Background_Info()
{
	...
	AI_Output(self,other,"DIA_Lee_Add_04_17");	//Королю! И его прихвостням. Они все горько пожалеют  о том, что сделали со мной...
};
...
func void DIA_Lee_Report_Info()
{
	...
	if(other.guild == GIL_SLD)
	{
		...
		AI_Output(self,other,"DIA_Lee_Add_04_23");	//А если нет... Тогда мы найдем другой способ вырваться отсюда...
	}
	else
	{
...
func void DIA_Lee_SYLVIO_Info()
{
	...
	AI_Output(self,other,"DIA_Lee_SYLVIO_04_05");	//Ах. Откровенно говоря, я даже рад, что Сильвио наконец ушел с фермы.
};
...
func void DIA_Lee_KnowWhereEnemy_No()
{
	...
	AI_Output(self,other,"DIA_Lee_KnowWhereEnemy_No_04_02");	//Если это только не полные кретины вроде Сильвио.

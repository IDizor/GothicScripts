...
func void DIA_Lester_SEND_XARDAS_Info()
{
	...
	AI_Output(self,other,"DIA_Lester_SEND_XARDAS_13_05");	//Хорошо, если это так важно, то я зайду к нему - но не сейчас.
...
func void DIA_Addon_Lester_STADT_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lester_STADT_13_04");	//Неужели? Ха, да тебя не пустят даже в сам город, не то, что к паладинам.
};
...
func void DIA_Lester_Sleep_Info()
{
	...
	AI_Output(self,other,"DIA_Lester_Sleep_13_01");	//Еще как. Я рассказал Ксардасу все. А теперь я посплю немного. Денек...
...
func void DIA_Lester_PERM3_Info()
{
	...
	AI_Output(self,other,"DIA_Lester_PERM3_13_16");	//Я думаю, мне лучше отдохнуть.
};

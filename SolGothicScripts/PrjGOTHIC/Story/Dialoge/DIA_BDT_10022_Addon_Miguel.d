...
func void DIA_Addon_Miguel_Story_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Miguel_Story_11_04");	//За это маги бросили меня за Барьер. 'Исследования запрещенных знаний,' - вот как они это назвали.
};
...
func void DIA_Addon_Miguel_WhereFrom_Info()
{
	...
	AI_Output(other,self,"DIA_Addon_Miguel_WhereFrom_15_03");	//Верно.
};

...
func void DIA_Addon_Bill_Perm2_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Bill_Perm2_03_02");	//Моей работой занимается Фрэнсис.
...
func void DIA_Addon_Bill_AngusnHank_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Bill_AngusnHank_03_01");	//Я не знаю, где они. Должно быть, бандиты их убили.
...
func void DIA_Addon_Bill_FoundFriends_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Bill_FoundFriends_03_03");	//Проклятые бандиты! Они убили их!
...
func void DIA_Addon_Bill_KilledEsteban_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Bill_KilledEsteban_03_03");	//Ну ладно. По крайней мере, эта свинья мертва.
...
func void DIA_Addon_Bill_Khorinis_Info()
{
	...
	if(GregIsBack == FALSE)
	{
		AI_Output(self,other,"DIA_Addon_Bill_Khorinis_03_05");	//Целый день пилю, чтобы построить никому не нужный частокол.
	};
};

...
{
	AI_Output(self,other,"DIA_Addon_Sancho_HI_06_00");	//Черт, еще один новичок. Тоже за золотом, да?
	AI_Output(other,self,"DIA_Addon_Sancho_HI_15_01");	//За золотом?
	AI_Output(self,other,"DIA_Addon_Sancho_HI_06_02");	//Не пытайся обдурить меня!

...
func void DIA_Mil_310_Stadtwache_FirstWarn_Info()
{
	...
	else
	{
		...
		{
			AI_Output(other,self,"DIA_Mil_310_Stadtwache_FirstWarn_15_18");	//Что?
...
func void DIA_Mil_310_Stadtwache_Bribe_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Mil_310_Stadtwache_Bribe_07_01");	//100 золотых - это неплохо. Проходи, конечно.
		if(B_GetGreatestPetzCrime(self) >= CRIME_ATTACK)
		{
...
func void DIA_Mil_310_Stadtwache_ZumSchmied_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Mil_310_Stadtwache_ZumSchmied_07_01");	//Да? А почему ты это сразу не сказал?
...
func void DIA_Mil_310_Stadtwache_Paladine_NoSomeone()
{
	...
	AI_Output(self,other,"DIA_Mil_310_Stadtwache_Paladine_NoSomeone_07_01");	//КТО послал тебя?
	Info_ClearChoices(DIA_Mil_310_Stadtwache_Paladine);

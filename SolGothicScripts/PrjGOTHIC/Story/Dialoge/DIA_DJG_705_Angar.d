...
func void DIA_AngarDJG_HALLO_Info()
{
	...
	AI_Output(self,other,"DIA_AngarDJG_HALLO_04_01");	//Зови меня просто Ангаром. Я потерял свой титул. Братства Спящего больше нет.
...
{
	AI_Output(self,other,"DIA_AngarDJG_UndeadMageDead_04_00");	//Здесь только смерть и разрушение. Я должен уходить отсюда.
	AI_StopProcessInfos(self);
...
{
	AI_Output(self,other,"DIA_AngarDJG_UNDEADMAGECOMES_04_00");	//Вот, опять! Ты слышишь это?
	AI_StopProcessInfos(self);

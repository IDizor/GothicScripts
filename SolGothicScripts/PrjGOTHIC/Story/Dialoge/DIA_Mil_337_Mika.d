...
func void DIA_Mika_UEBERLEGT_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Mika_UEBERLEGT_12_02");	//Возвращайся, когда у тебя будут деньги.
		AI_StopProcessInfos(self);
	};
};
...
func void DIA_Mika_HILFE_Akil()
{
	...
	AI_Output(self,other,"DIA_Mika_HILFE_Akil_12_01");	//Что? Этот сброд ошивается вокруг фермы Акила? Тогда не будем терять времени попусту. Идем за мной.
	AI_StopProcessInfos(self);

...
func void DIA_Addon_Cavalorn_HALLO_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Cavalorn_HALLO_08_01");	//Черт. Я не знаю, где они все прячутся. Убиваешь одного - и вскоре они все возвращаются.
...
func void DIA_Addon_Cavalorn_HALLO_Stadt()
{
	...
	AI_Output(self,other,"DIA_Addon_Cavalorn_HALLO_Stadt_08_01");	//Ну-ну. В город. Хех.
...
func void DIA_Addon_Cavalorn_HALLO_Bauern()
{
	...
	AI_Output(self,other,"DIA_Addon_Cavalorn_HALLO_Bauern_08_01");	//Правда? Хм-м. Я бы хотел пойти с тобой, но у меня здесь есть дела, которые я должен закончить.
...
func void DIA_Addon_Cavalorn_ARTEFAKT_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Cavalorn_ARTEFAKT_08_01");	//Да. Они выключили меня и бросили на завтрак гоблинам.
...
func void DIA_Addon_Cavalorn_HELFEN_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Cavalorn_HELFEN_08_01");	//Возможно. Но ты выглядишь таким тощим, ты наверняка не держал меча несколько недель.
	};
...
func void B_Addon_Cavalorn_VatrasBrief()
{
	if(MIS_Addon_Cavalorn_Letter2Vatras != LOG_SUCCESS)
	{
		...
		AI_Output(self,other,"DIA_Addon_Cavalorn_VatrasBrief_08_05");	//Хм-м. А почему бы и нет... Ты можешь доставить письмо в город.
	};

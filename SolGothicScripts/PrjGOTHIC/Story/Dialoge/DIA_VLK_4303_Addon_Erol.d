...
func void DIA_Addon_Erol_Hallo_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Erol_Hallo_10_01");	//В чем дело? Ты только посмотри на этот бардак под мостом!
...
{
	AI_Output(other,self,"DIA_Addon_Erol_SLD_15_00");	//Это и есть твой дом?
...
func void DIA_Addon_Erol_Teach_Info()
{
	...
	else if(Erol_Bonus == FALSE)
	{
		...
		AI_Output(self,other,"DIA_Addon_Erol_Teach_Add_10_03");	//Если ты нанесешь удар правильно, ты это поймешь!

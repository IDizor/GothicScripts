...
func void DIA_Schwarzmagier_HELLO_hinterTor()
{
	...
	AI_Output(self,other,"DIA_Schwarzmagier_HELLO_hinterTor_09_01");	//Покои моего повелителя останутся недоступными для тебя. Я не дам тебе возможности открыть эти врата.
};
...
func void DIA_Schwarzmagier_HELLO_meister()
{
	...
	AI_Output(self,other,"DIA_Schwarzmagier_HELLO_meister_09_00");	//Хватит болтовни! Я уничтожу тебя.
	AI_Output(self,other,"DIA_Schwarzmagier_HELLO_meister_09_01");	//Твой взор потухнет, и твой дух растает во тьме.
	if(Npc_HasItems(other,ItAm_Prot_BlackEye_Mis))
	{
		AI_Output(other,self,"DIA_Schwarzmagier_HELLO_meister_15_02");	//Без этого амулета вызова душ у меня бы были большие проблемы сейчас.
	}
	else
	{

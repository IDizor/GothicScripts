...
func void B_Say_Wache_kaputt()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10019_Wache_kaputt_06_01");	//Заработались до смерти.
	Info_ClearChoices(DIA_Addon_BDT_10019_Wache_Hi);
};
...
func void DIA_Addon_BDT_10019_Wache_Hi_Raven()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10019_Wache_Hi_Raven_06_01");	//Эй! Только попробуй войти в храм - и ты погибнешь так же, как эти заключенные.

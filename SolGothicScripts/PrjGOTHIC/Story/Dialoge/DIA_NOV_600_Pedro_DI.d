...
func void DIA_Pedro_DI_YOU_grund()
{
	...
	AI_Output(self,other,"DIA_Pedro_DI_YOU_grund_09_01");	//Оставь меня в живых. Я могу рассказать кое-что, что поможет тебе выбраться отсюда. Ты должен выслушать меня.
};
...
func void DIA_Pedro_DI_YOU_Serpentes()
{
	...
	AI_Output(self,other,"DIA_Pedro_DI_YOU_Serpentes_09_01");	//Пожалуйста, нет. Ты не можешь сделать это. Я могу очень пригодиться тебе. Ты увидишь это.
...
func void DIA_Pedro_DI_YOU_verschon()
{
	...
	AI_Output(self,other,"DIA_Pedro_DI_YOU_verschon_09_01");	//Да, конечно. Я расскажу тебе все, что ты хочешь знать. Но при одном условии. Ты должен забрать меня с этого проклятого острова, слышишь?
	Info_ClearChoices(DIA_Pedro_DI_YOU);
	Info_AddChoice(DIA_Pedro_DI_YOU,"И слышать ничего не хочу. Я убью тебя.",DIA_Pedro_DI_YOU_tot);

...
func void DIA_DiegoNW_NeedHelp_Info()
{
	if(Diego_IsDead == TRUE)
	{
		...
		AI_Output(self,other,"DIA_Addon_DiegoNW_NeedHelp_11_02");	//А ты думал, что мне пришел конец, верно?
...
func void DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_WhereGold_End_TryIt()
{
	...
	AI_Output(self,other,"DIA_DiegoNW_NeedHelp_Problem_TryIt_11_01");	//Сделай это. Этого будет достаточно для меня.
	Info_ClearChoices(DIA_DiegoNW_NeedHelp);
};
...
func void DIA_DiegoNW_DeliveredLetter_Info()
{
	...
	AI_Output(self,other,"DIA_DiegoNW_DeliveredLetter_11_03");	//Я так и думал.

...
func void DIA_Addon_10026_Wache_Hi_Info()
{
	...
	if(Sklaven_Flucht == FALSE)
	{
		...
		AI_Output(self,other,"DIA_Addon_BDT_10026_Wache_Hi_13_02");	//С этими ребятами покончено. Возможно, потому что они почти ничего не ели.
...
func void DIA_Addon_10026_Wache_Gruft_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10026_Wache_Gruft_13_02");	//Просто следуй по трупам - и ты найдешь ее.
};

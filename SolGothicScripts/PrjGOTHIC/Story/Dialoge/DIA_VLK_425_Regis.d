...
func void DIA_Regis_ValDefeat_Info()
{
	...
	AI_Output(self,other,"DIA_Regis_Add_13_18");	//Он заслужил это...
	if(!Npc_IsDead(Valentino))
	{
		...
		Regis_Ring = TRUE;
		AI_Output(self,other,"DIA_Regis_Add_13_20");	//Ты можешь передать его следующему, кто надает ему тумаков...
	};
};

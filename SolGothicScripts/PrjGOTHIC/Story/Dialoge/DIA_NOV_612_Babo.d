...
func void DIA_Babo_Kap3_Unhappy_Info()
{
	...
	AI_Output(self,other,"DIA_Babo_Kap3_Unhappy_03_01");	//Эээ... я хочу сказать, со мной все в порядке, правда.
...
func void DIA_Babo_Kap3_Unhappy_Lament()
{
	...
	AI_Output(self,other,"DIA_Babo_Kap3_Unhappy_Lament_03_01");	//Я... Я... пожалуйста, не говори магам.
...
func void DIA_Babo_Kap3_Unhappy_Documents()
{
	...
	AI_Output(self,other,"DIA_Babo_Kap3_Unhappy_Documents_03_01");	//Это никого не касается. Это мое личное дело.
...
func void DIA_Babo_Kap3_Unhappy_CanHelpYou()
{
	...
	AI_Output(self,other,"DIA_Babo_Kap3_Unhappy_CanHelpYou_03_03");	//Конечно же, я заплачу тебе за это.
...
func void DIA_Babo_Kap3_HaveYourDocs_Info()
{
	...
	AI_Output(self,other,"DIA_Babo_Kap3_HaveYourDocs_03_03");	//Это действительно мои? Ты уверен? Покажи мне.
...
func void DIA_Babo_Kap3_HaveYourDocs_KeepThem_Partner()
{
	...
	AI_Output(self,other,"DIA_Babo_Kap3_HaveYourDocs_KeepThem_Partner_03_01");	//Что? Ты не можешь поступить со мной так.
...
func void DIA_Babo_Kap3_Perm_Info()
{
	...
	if(hero.guild == GIL_KDF)
	{
		AI_Output(self,other,"DIA_Babo_Kap3_Perm_03_01");	//Да, конечно. Моя вера в мудрость и силу Инноса придает мне силы.
		AI_Output(self,other,"DIA_Babo_Kap3_Perm_03_02");	//Я не хочу показаться невежливым, но у меня много дел сегодня.
		AI_Output(other,self,"DIA_Babo_Kap3_Perm_15_03");	//Можешь продолжать.
		AI_Output(self,other,"DIA_Babo_Kap3_Perm_03_04");	//Спасибо.
	}
	else
	{

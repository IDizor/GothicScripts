...
{
	AI_Output(self,other,"DIA_Parlan_HAMMER_05_00");	//Подожди минутку, сын мой, сын мой.
...
func void DIA_Parlan_WELCOME_Info()
{
	...
	AI_Output(self,other,"DIA_Parlan_WELCOME_05_02");	//...ПОСЛУШНИК. Не важно, кем ты был раньше. Теперь ты слуга Инноса. Только это имеет значение.
...
func void DIA_Parlan_KNOWSJUDGE_Info()
{
	...
	AI_Output(self,other,"DIA_Parlan_KNOWSJUDGE_05_01");	//Что?.. Хм... Ты это действительно серьезно?
...
func void DIA_Parlan_TEACH_MANA_Info()
{
	...
	Info_AddChoice(DIA_Parlan_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(1),B_GetLearnCostAttribute(other,ATR_MANA_MAX)),DIA_Parlan_TEACH_MANA_1);
	Info_AddChoice(DIA_Parlan_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(5),B_GetLearnCostAttribute(other,ATR_MANA_MAX) * 5),DIA_Parlan_TEACH_MANA_5);
};

func void DIA_Parlan_TEACH_MANA_BACK()
{
	if(other.attribute[ATR_MANA_MAX] >= T_MED * ManaTeachersLimitMultiplier)
	{
...
{
	B_TeachAttributePoints(self,other,ATR_MANA_MAX,ManaPoints(1),T_MED * ManaTeachersLimitMultiplier);
	Info_ClearChoices(DIA_Parlan_TEACH_MANA);
	Info_AddChoice(DIA_Parlan_TEACH_MANA,Dialog_Back,DIA_Parlan_TEACH_MANA_BACK);
	Info_AddChoice(DIA_Parlan_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(1),B_GetLearnCostAttribute(other,ATR_MANA_MAX)),DIA_Parlan_TEACH_MANA_1);
	Info_AddChoice(DIA_Parlan_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(5),B_GetLearnCostAttribute(other,ATR_MANA_MAX) * 5),DIA_Parlan_TEACH_MANA_5);
...
{
	B_TeachAttributePoints(self,other,ATR_MANA_MAX,ManaPoints(5),T_MED * ManaTeachersLimitMultiplier);
	Info_ClearChoices(DIA_Parlan_TEACH_MANA);
	Info_AddChoice(DIA_Parlan_TEACH_MANA,Dialog_Back,DIA_Parlan_TEACH_MANA_BACK);
	Info_AddChoice(DIA_Parlan_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(1),B_GetLearnCostAttribute(other,ATR_MANA_MAX)),DIA_Parlan_TEACH_MANA_1);
	Info_AddChoice(DIA_Parlan_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(5),B_GetLearnCostAttribute(other,ATR_MANA_MAX) * 5),DIA_Parlan_TEACH_MANA_5);
...
instance DIA_Parlan_CIRCLE1(C_Info)
{
	...
	permanent = TRUE;
	description = "Научи меня первому Кругу магии. (5 LP)";
};
...
instance DIA_Parlan_CIRCLE2(C_Info)
{
	...
	permanent = TRUE;
	description = "Научи меня второму Кругу магии. (5 LP)";
};
...
instance DIA_Parlan_CIRCLE3(C_Info)
{
	...
	permanent = TRUE;
	description = "Научи меня третьему Кругу магии. (5 LP)";
};
...
{
	AI_Output(self,other,"DIA_Parlan_DontDisturb_05_00");	//Я не люблю повторять. Оставь послушников в покое.
...
func void DIA_Parlan_Kap3U4U5_PERM_Church()
{
	...
	AI_Output(self,other,"DIA_Parlan_Add_05_01");	//Где церковь? Ох, боже, и куда же она подевалась?!
};

...
func void DIA_Addon_Logan_EXIT_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Logan_EXIT_10_01");	//Да-а, просто убегаешь. А я останусь здесь и остановлю каждого, кто подойдет слишком близко.
	};
...
func void DIA_Addon_Logan_How2_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Logan_How2_10_05");	//Эстебан считает, что в этом замешан Снаф. Мне нужно следить за ним...
};
...
func void DIA_Addon_Logan_HI_Info()
{
	...
	if(Npc_KnowsInfo(other,DIA_Addon_Franco_HI) && !Npc_IsDead(Franco))
	{
...
func void DIA_Addon_Logan_Why_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Logan_Why_10_01");	//Франко сгноит тебя здесь, если ты этого не сделаешь.
	};
	...
	if(!Npc_IsDead(Franco))
	{
		...
		AI_Output(self,other,"DIA_Addon_Logan_Why_10_06");	//И следующим, кто туда попадет, буду я...... Лучше бы это было так...
	};
...
func void DIA_Addon_Logan_Lager_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Logan_Lager_10_01");	//Вопрос в том, чего НЕТ в лагере. Там нет болотных акул, там нет болотных кочек... Вообще НЕТ болота.

...
func void DIA_Alvares_ATTACK_Kerle()
{
	...
	AI_Output(self,other,"DIA_Alvares_ATTACK_Kerle_11_02");	//Ёнгардо, давай начинать! “ы берешь на себ€ фермера - а € разберусь с этим клоуном!
	AI_StopProcessInfos(self);
	B_Attack(self,other,AR_SuddenEnemyInferno,1);
};
...
func void DIA_Alvares_Schluss_Info()
{
	...
	AI_Output(self,other,"DIA_Alvares_Schluss_11_01");	//’орошо - значит, мне придетс€ убить теб€. Ёнгардо, давай, прикончим их!
	AI_StopProcessInfos(self);
	B_Attack(self,other,AR_SuddenEnemyInferno,1);
};

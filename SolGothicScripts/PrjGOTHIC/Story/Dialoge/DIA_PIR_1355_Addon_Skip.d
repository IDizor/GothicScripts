...
func void DIA_Addon_Skip_ArmorPrice_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Skip_ArmorPrice_08_03");	//А тебя просто так не отговорить, верно? Ну хорошо. У нас был комплект таких доспехов.
...
func void DIA_Addon_Skip_Raven_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Skip_Raven_08_02");	//От нее до нашего лагеря камень добросить можно. Понятно, что они будут за нами шпионить.
...
func void DIA_Addon_Skip_AngusHank_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Skip_AngusnHank_08_08");	//Впрочем, жизнь продолжается. Потерю товара мы переживем. Но у них был с собой грог...
	AI_Output(self,other,"DIA_Addon_Skip_AngusnHank_08_09");	//По меньшей мере, 20 бутылок!

...
func void DIA_Addon_Fortuno_Hi_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Fortuno_Hi_13_00");	//Темное облако накрыло дом... ОН приближается...
...
func void DIA_Addon_Fortuno_Hi_GREEN()
{
	...
	AI_Output(self,other,"DIA_Addon_Fortuno_Hi_GREEN_13_01");	//А-А-А-Х...
...
func void DIA_Addon_Fortuno_wer_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Fortuno_wer_13_08");	//Мне жаль. Чувство такое, будто мой разум сам заключен в тюрьму. Я и сам этого не понимаю...
};
...
func void DIA_Addon_Fortuno_Trade_all()
{
	...
	B_GiveInvItems(self,other,ItMi_Gold,amount * Value_SwampHerb * 2);
...
func void DIA_Addon_Fortuno_Trade_1()
{
	...
	B_GiveInvItems(self,other,ItMi_Gold,Value_SwampHerb * 5);
	B_GivePlayerXP(10);
	B_Fortuno_InfoManager();
};
...
func void DIA_Addon_Fortuno_more_Info()
{
	...
	Log_SetTopicStatus(Topic_Addon_Fortuno,LOG_SUCCESS);

...
func void DIA_Cornelius_SeeMurder_Info()
{
	...
	AI_Output(self,other,"DIA_Cornelius_SeeMurder_13_01");	//Я не обязан отвечать на такие вопросы.
...
func void DIA_Cornelius_WhatYouSee_Info()
{
	...
	AI_Output(self,other,"DIA_Cornelius_WhatYouSee_13_01");	//Послушай, у меня нет времени на болтовню с тобой.
	AI_Output(self,other,"DIA_Cornelius_WhatYouSee_13_02");	//Уходи, я сейчас никого не принимаю.
...
func void DIA_Cornelius_Enough_Info()
{
	...
	AI_Output(self,other,"DIA_Cornelius_Enough_13_01");	//Я... я видел, как наемник нанес удар в спину паладину.
	AI_Output(self,other,"DIA_Cornelius_Enough_13_02");	//А затем он вынул свой меч и вонзил его ему в грудь.
	AI_Output(other,self,"DIA_Cornelius_Enough_15_03");	//Ты в этом совершенно уверен?
	AI_Output(self,other,"DIA_Cornelius_Enough_13_04");	//Да, конечно. Я видел это своим собственными глазами.
	AI_Output(self,other,"DIA_Cornelius_Enough_13_05");	//Но мне правда сейчас некогда. Мне нужно работать с документами.
	AI_StopProcessInfos(self);
};
...
func void DIA_Cornelius_DontBelieveYou_Info()
{
	...
	AI_Output(self,other,"DIA_Cornelius_DontBelieveYou_13_01");	//И что? Что ты собираешься делать?
...
func void DIA_Cornelius_DontBelieveYou_WhatYouWant()
{
	...
	AI_Output(self,other,"DIA_Cornelius_DontBelieveYou_WhatYouWant_13_01");	//У тебя не хватит золота, чтобы заплатить мне.
...
func void DIA_Cornelius_DontBelieveYou_WantSurvive()
{
	...
	AI_Output(self,other,"DIA_Cornelius_DontBelieveYou_WantSurvive_13_01");	//Если ты нападешь на меня, тебя повесят.
...
func void DIA_Cornelius_DontBelieveYou_Monastery()
{
	...
	AI_Output(self,other,"DIA_Cornelius_DontBelieveYou_Monastery_13_01");	//Что ты этим хочешь сказать?
...
func void DIA_Cornelius_DontBelieveYou_KnowYourHome()
{
	...
	AI_Output(self,other,"DIA_Cornelius_DontBelieveYou_KnowYourHome_13_01");	//Что ты этим хочешь сказать?

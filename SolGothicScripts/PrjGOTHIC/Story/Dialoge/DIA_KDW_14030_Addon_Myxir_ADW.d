...
func void DIA_Addon_Myxir_PermADW_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Myxir_PermADW_12_01");	//Да, я на этом настаиваю.
};
...
func void DIA_Addon_Myxir_GeistTafel_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Myxir_GeistTafel_12_03");	//О, Аданос!
...
func void DIA_Addon_Myxir_TalkedToGhost_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Myxir_TalkedToGhost_12_01");	//Тебе действительно удалось пробудить его от смертного сна?

...
func void DIA_Rod_Wette_Info()
{
	...
	AI_Output(self,other,"DIA_Rod_Wette_06_01");	//Точно? Хмм... И сколько же мне с тебя взять?
...
func void DIA_Rod_Wette_Yes()
{
	...
	if(B_GiveInvItems(other,self,ItMi_Gold,30))
	{
		...
		AI_Output(self,other,"DIA_Rod_Wette_Yes_06_03");	//Хорошо, давай посмотрим, насколько ты силен...
		...
		if(other.attribute[ATR_STRENGTH] >= Condition_Rod)
		{
			...
			AI_Output(self,other,"DIA_Rod_Wette_Yes_06_05");	//Похоже, ты побил меня.
...
func void DIA_Rod_Wette_KeepIt()
{
	...
	AI_Output(self,other,"DIA_Rod_Wette_KeepIt_06_01");	//Что это значит?

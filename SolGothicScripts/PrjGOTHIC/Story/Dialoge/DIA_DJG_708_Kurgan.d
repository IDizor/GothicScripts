...
{
	AI_Output(other,self,"DIA_Kurgan_KillDragon_15_00");	//Так вы хотите убить драконов?
...
func void DIA_Kurgan_AllDragonsDead_Info()
{
	...
	AI_Output(self,other,"DIA_Kurgan_AllDragonsDead_01_03");	//Ха. Ты даже сам в это не веришь. Хватит нести чушь.
};

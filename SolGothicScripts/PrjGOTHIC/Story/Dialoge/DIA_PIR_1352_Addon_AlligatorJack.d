...
func void DIA_Addon_AlligatorJack_WerBistDu_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_AlligatorJack_WerBistDu_12_02");	//Я - Аллигатор Джек.
...
func void DIA_Addon_AlligatorJack_Vorschlag_tot()
{
	...
	AI_Output(self,other,"DIA_Addon_AlligatorJack_Vorschlag_tot_12_01");	//Что? Ты? И как же ты собираешься это сделать?
...
func void DIA_Addon_AlligatorJack_Greg_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_AlligatorJack_Greg_12_03");	//Грега? В Хоринисе? Чепуха!

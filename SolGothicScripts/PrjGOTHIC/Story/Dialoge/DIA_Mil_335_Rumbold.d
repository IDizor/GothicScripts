...
func void DIA_Rumbold_HALLO_verschwindet()
{
	...
	AI_Output(self,other,"DIA_Rumbold_HALLO_verschwindet_10_02");	//А что будет, если мы этого не сделаем, эй?
	Info_ClearChoices(DIA_Rumbold_Hallo);
...
func void DIA_Rumbold_HALLO_geld_ok()
{
	...
	AI_Output(self,other,"DIA_Rumbold_HALLO_geld_ok_10_01");	//Меня не волнует, кто платит за Бенгара. Удачи. Кретин!
	AI_StopProcessInfos(self);

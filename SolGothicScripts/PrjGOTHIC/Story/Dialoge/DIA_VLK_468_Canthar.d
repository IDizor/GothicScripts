...
func void DIA_Canthar_PersonalCRIMES_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Canthar_PersonalCRIMES_09_01");	//Ты думал, что так просто сможешь справиться со мной?
	};
...
func void DIA_Canthar_Hallo_Info()
{
	...
	if(Npc_HasEquippedArmor(other) == FALSE)
	{
		...
		AI_Output(self,other,"DIA_Canthar_Hallo_09_03");	//Хм! ты похож на беглеца! Все беглецы направляются в город.
...
func void DIA_Canthar_WhatOffer_Info()
{
	...
	if(Canthar_GotMe == TRUE)
	{
		...
		{
			AI_Output(self,other,"DIA_Canthar_WhatOffer_09_02");	//Если ты будешь говорить так же 'убедительно' со стражей у ворот, как говоришь со мной, они никогда не пустят тебя в город.
		};
...
func void DIA_Canthar_WhatOffer_Price()
{
	...
	AI_Output(self,other,"DIA_Canthar_WhatOffer_Price_09_01");	//Я ЗНАЛ, что не ошибся в тебе!
...
func void DIA_Canthar_Pay_Ja()
{
	...
	AI_Output(self,other,"DIA_Canthar_Pay_Ja_09_01");	//Хорошо. А теперь я позабочусь, чтобы твоя репутация среди торговцев выросла опять.

...
func void DIA_Gerbrandt_GreetingsFromDiego_Info()
{
	...
	AI_Output(self,other,"DIA_Gerbrandt_GreetingsFromDiego_10_01");	//Что? Кто? Какой Диего?
	...
	B_UseFakeScroll();
	AI_Output(self,other,"DIA_Gerbrandt_GreetingsFromDiego_10_03");	//Этого не может быть. Нет. Мне конец!
	AI_Output(self,other,"DIA_Gerbrandt_GreetingsFromDiego_10_04");	//Он что, уже в городе?
	...
	AI_Output(self,other,"DIA_Gerbrandt_GreetingsFromDiego_10_08");	//Это конец! Все пропало!

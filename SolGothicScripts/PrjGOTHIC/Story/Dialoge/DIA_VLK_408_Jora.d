...
func void DIA_Jora_HolDeinGold_Info()
{
	...
	AI_Output(self,other,"DIA_Jora_HolDeinGold_08_01");	//Да? А зачем тебе это?
...
func void DIA_Jora_HolDeinGold_ToOV()
{
	...
	AI_Output(self,other,"DIA_Jora_HolDeinGold_08_03");	//Ты обратился не по адресу. Я нездешний, как и большинство торговцев на этой площади.
...
func void DIA_Jora_AlriksSchwert_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Jora_AlriksSchwert_08_08");	//У меня его больше нет! Черт его знает, кому я его продал!
	};
};
...
func void DIA_Jora_BUYAlriksSchwert_Info()
{
	...
	if(B_GiveInvItems(other,self,ItMi_Gold,50))
	{
		AI_Output(self,other,"DIA_Jora_BUYAlriksSchwert_08_04");	//Вот, держи - это выгодная сделка.
		B_GiveInvItems(self,other,ItMw_AlriksSword_Mis,1);
	}
	else
	{

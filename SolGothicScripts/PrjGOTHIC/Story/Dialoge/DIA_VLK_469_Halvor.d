...
func void DIA_Halvor_MESSAGE_Info()
{
	...
	B_UseFakeScroll();
	AI_Output(self,other,"DIA_Halvor_MESSAGE_06_02");	//Э-э... Хорошо, давай поговорим спокойно об этом - э-э... послушай. Я перепродал товары, полученные от бандитов.
	AI_Output(self,other,"DIA_Halvor_MESSAGE_06_03");	//Но нет необходимости сообщать об этом ополчению, правда? Я уверен, мы можем прийти к взаимопониманию, разве нет?
...
func void DIA_Halvor_Zeichen_Info()
{
	...
	AI_Output(self,other,"DIA_Halvor_Zeichen_06_01");	//Я готов сделать тебе предложение. Если у тебя есть серебряные тарелки или чаши, я возьму их по хорошей цене.

...
func void DIA_Nagur_Job_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Nagur_Add_08_00");	//Здесь, в гавани НЕТ работы для людей из монастыря!
		B_Nagur_Abfertigen();
	}
	...
	{
		AI_Output(self,other,"DIA_Nagur_Job_08_01");	//Так, так... Ты ищешь особенную работу. Ладно. Но будем играть по моим правилам, понятно?

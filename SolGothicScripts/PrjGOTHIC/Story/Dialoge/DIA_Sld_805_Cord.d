...
func void DIA_Addon_Cord_YouAreRanger_waffe()
{
	...
	if(Cord_SC_Dreist == FALSE)
	{
		AI_Output(self,other,"DIA_Addon_Cord_Add_14_03");	//Неужели?
...
func void DIA_Addon_Cord_YouAreRanger_SLDAufnahme()
{
	...
	AI_Output(self,other,"DIA_Addon_Cord_YouAreRanger_SLDAufnahme_14_01");	//Все понятно. Ладно, я попытаюсь. Что еще?
...
func void DIA_Cord_ReturnPatrick_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Cord_ReturnPatrick_14_07");	//Я собирался сказать тебе, что ты нахальный и скользкий малый.

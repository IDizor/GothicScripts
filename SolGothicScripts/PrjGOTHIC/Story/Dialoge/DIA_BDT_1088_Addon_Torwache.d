...
func void DIA_BDT_1088_Addon_Torwache_FirstWarn_Info()
{
	...
	else if((MIS_Send_Buddler != LOG_Running) && (MIS_Send_Buddler != LOG_SUCCESS))
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_04");	//Ты что, не понял? ПОШЕЛ ОТСЮДА!
			Torwache_Greetings = 2;
		}
		else
		{
			AI_Output(self,other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_05");	//ПОШЕЛ ОТСЮДА!
		};
	}
...
func void DIA_BDT_1088_Addon_Torwache_Attack_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_1088_Addon_Torwache_Attack_06_00");	//Ты думаешь, я шучу? Я покажу тебе...
	AI_StopProcessInfos(self);

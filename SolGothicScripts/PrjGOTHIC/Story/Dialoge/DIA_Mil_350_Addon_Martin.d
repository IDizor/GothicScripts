...
func void DIA_Addon_Martin_Rangerhelp_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Martin_Rangerhelp_07_03");	//Итак, ты хочешь вступить в наши ряды? Мы, знаешь ли, не берем просто так людей с улицы.
	...
	AI_Output(self,other,"DIA_Addon_Martin_Rangerhelp_07_06");	//Ну хорошо. Тогда слушай меня внимательно.
	...
	AI_Output(self,other,"DIA_Addon_Martin_Rangerhelp_07_09");	//Довольно странно, что эти паладины ничего не замечают.
...
func void DIA_Addon_Martin_Auftrag_Info()
{
	...
	Info_AddChoice(DIA_Addon_Martin_Auftrag,"(далее)",DIA_Addon_Martin_Auftrag_weiter);
};
...
func void DIA_Addon_Martin_Perm_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Martin_Perm_07_01");	//Проклятый лентяй, ты должен был охранять эти ящики! Еще несколько вещей пропало!

...
func void DIA_Addon_Lennar_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lennar_Hi_01_03");	//Верно, но бандиты здесь только для того, чтобы добывать руду. Так что...
};
...
func void DIA_Addon_Lennar_Attentat_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lennar_ATTENTAT_01_03");	//Я уверен, что во всем виноват Эмилио!
	AI_Output(self,other,"DIA_Addon_Lennar_ATTENTAT_01_04");	//Он всегда рвался в шахту, как ужаленный, и копал до изнеможения.
	...
	AI_Output(self,other,"DIA_Addon_Lennar_ATTENTAT_01_07");	//Думаю, он просто не в силах посмотреть ему в глаза.

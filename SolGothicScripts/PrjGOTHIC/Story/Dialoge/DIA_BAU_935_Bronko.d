...
{
	AI_Output(self,other,"DIA_Bronko_HALLO_06_00");	//И куда это мы направляемся, а?
...
func void DIA_Bronko_HALLO_hiergeld()
{
	...
	if(Npc_HasItems(other,ItMi_Gold) >= 5)
	{
		...
		AI_Output(self,other,"DIA_Bronko_HALLO_hiergeld_06_01");	//Спасибо. Удачного пути.
		AI_StopProcessInfos(self);
	}
	else
	{
...
func void DIA_Bronko_FLEISSIG_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Bronko_FLEISSIG_06_03");	//Ты ведь не приведешь сюда этих наемников, да?
	};

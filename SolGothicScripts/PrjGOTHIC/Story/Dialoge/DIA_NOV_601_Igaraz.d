...
{
	AI_Output(self,other,"DIA_Igaraz_IMTHEMAN_13_00");	//Это свершилось. Иннос выбрал меня я приму участие в испытании магией.
};
...
func void DIA_Igaraz_ADD_Info()
{
	...
	AI_Output(self,other,"DIA_Igaraz_Add_13_01");	//Нет! Тебе дал задание Серпентес?
	...
	AI_Output(self,other,"DIA_Igaraz_Add_13_09");	//ЕСЛИ тебе вообще удастся уйти далеко...
	AI_Output(self,other,"DIA_Igaraz_Add_13_10");	//Это все что я могу сказать тебе... Это ведь все же должно быть твое ИСПЫТАНИЕ!
};
...
func void DIA_Igaraz_Price_Info()
{
	...
	AI_Output(self,other,"DIA_Igaranz_Price_13_01");	//Ха, вообще-то говоря, они практически бесценны. Очень редко можно встретить что-нибудь подобное.

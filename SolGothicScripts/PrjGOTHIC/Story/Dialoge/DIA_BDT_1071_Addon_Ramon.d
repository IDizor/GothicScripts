...
func void DIA_Addon_Ramon_FirstWarn_Info()
{
	if(Npc_IsDead(Franco))
	{
		...
		AI_Output(self,other,"DIA_Addon_Ramon_FirstWarn_07_07");	//Это не так просто. Мы НИКОГО не просили, так что НИКТО не войдет.
		...
		AI_Output(self,other,"DIA_Addon_Ramon_FirstWarn_07_09");	//Ты не отстанешь, верно? Ну ладно, тогда давай сюда.

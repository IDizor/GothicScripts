...
func void DIA_Addon_Esteban_Mine_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Esteban_Mine_07_01");	//Естественно. Тогда ты пришел в правильное место к правильному человеку.
...
func void DIA_Addon_Esteban_Rot_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Esteban_Rot_07_03");	//Много ли ты знаешь о том, как добывать золото?
	...
	AI_Output(self,other,"DIA_Addon_Esteban_Rot_07_06");	//Если я и дам тебе красный камень, то не потому, что ты такой хороший рудокоп.
...
func void DIA_Addon_Esteban_fight_Info()
{
	...
	AI_Output(other,self,"DIA_Addon_Esteban_fight_15_04");	//Каким охранникам?..

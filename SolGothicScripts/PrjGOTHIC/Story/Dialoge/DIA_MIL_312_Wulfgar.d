...
func void DIA_Wulfgar_AboutMiliz_Info()
{
	...
	AI_Output(self,other,"DIA_Wulfgar_AboutMiliz_04_02");	//Раньше ополчение подчинялось губернатору. Он понятия не имел, чем мы занимались здесь.
...
func void DIA_Wulfgar_CanYouTrain_Info()
{
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Wulfgar_CanYouTrain_04_06");	//Хорошо, ты можешь приступать, когда пожелаешь.

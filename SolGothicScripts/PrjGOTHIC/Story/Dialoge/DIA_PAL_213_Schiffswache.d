...
func void DIA_Pal_213_Schiffswache_IAmKDF_Info()
{
	...
	AI_Output(self,other,"DIA_Pal_213_Schiffswache_IAmKDF_01_01");	//Нет, конечно же, нет. Да простит меня Иннос.
...
func void DIA_Pal_213_Schiffswache_IAmKDF2_Info()
{
	...
	AI_Output(self,other,"DIA_Pal_213_Schiffswache_IAmKDF2_01_01");	//Я должен убить... я хочу сказать, остановить тебя.
};
...
func void DIA_Pal_213_Schiffswache_IAmKDF3_Info()
{
	...
	AI_Output(self,other,"DIA_Pal_213_Schiffswache_IAmKDF3_01_03");	//Ничего, господин.
};
...
func void DIA_Pal_213_Schiffswache_IAmKDF6_Info()
{
	...
	AI_Output(self,other,"DIA_Pal_213_Schiffswache_IAmKDF6_01_01");	//Понятно. Ты можешь взойти на корабль.
	MIS_ShipIsFree = TRUE;

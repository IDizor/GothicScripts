...
func void DIA_Till_BRONKO_Info()
{
	...
	AI_Output(self,other,"DIA_Till_BRONKO_03_01");	//Эээ. Да. Я знаю. Это Бронко. Он делает то, что хочет.
...
func void DIA_Till_BRONKOWIEDERANARBEIT_Info()
{
	...
	if(Till_Angebot <= 50)
	{
		AI_Output(self,other,"DIA_Till_BRONKOWIEDERANARBEIT_03_03");	//Мммм. Хорошо. Сделка есть сделка, правда?

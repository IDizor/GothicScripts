...
func void DIA_Addon_Greg_NW_Stadtwachen_Schein()
{
	...
	AI_Output(self,other,"DIA_Addon_Greg_NW_Stadtwachen_Schein_01_01");	//Ага. Ты хочешь сказать, что я должен выдать себя за горожанина?
...
func void DIA_Addon_Greg_NW_MeetGregSecondTime_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Greg_NW_MeetGregSecondTime_01_03");	//Я думал, что ты хочешь мне помочь! А ты просто сбежал.
...
func void DIA_Addon_Greg_NW_was_Info()
{
	...
	if(MIS_Addon_Greg_BringMeToTheCity != 0)
	{
		...
		AI_Output(self,other,"DIA_Addon_Greg_NW_was_01_02");	//Сейчас у ТЕБЯ начнутся проблемы, придурок.
	};
...
func void DIA_Addon_Greg_NW_was_NoHelp()
{
	...
	AI_Output(self,other,"DIA_Addon_Greg_NW_was_NoHelp_01_01");	//Нет, ты не ХОЧЕШЬ мне помочь.
...
func void DIA_Addon_Greg_NW_was_HierGold()
{
	...
	AI_Output(self,other,"DIA_Addon_Greg_NW_was_HierGold_01_01");	//Можешь оставить себе свои жалкие сбережения. У меня есть мысль получше.
...
func void DIA_Addon_Greg_NW_RakeCavePlundered_gold()
{
	...
	AI_Output(self,other,"DIA_Addon_Greg_NW_RakeCavePlundered_gold_01_01");	//Давай его сюда.
...
{
	AI_Output(self,other,"DIA_Addon_Greg_NW_CaughtDexter_01_00");	//Ну и где эта свинья?
...
func void DIA_Addon_Greg_NW_RavensLetter_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Greg_NW_RavensLetter_01_09");	//Значит, я здесь застрял.

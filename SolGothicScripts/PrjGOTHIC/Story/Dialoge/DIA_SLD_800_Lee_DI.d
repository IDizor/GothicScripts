...
func void DIA_Lee_DI_UndeadDragonDead_Info()
{
	...
	if((DIA_Lee_DI_UndeadDragonDead_OneTime == FALSE) && (hero.guild == GIL_DJG))
	{
		...
		AI_Output(self,other,"DIA_Lee_DI_UndeadDragonDead_04_07");	//Да. Без хорошего отряда ничего не получится. Для меня было большой честью биться с тобой бок о бок.

...
func void dia_bdt_1013_bandit_where_prisoner()
{
	...
	AI_Output(self,other,"DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_01");	//Ты пришел из-за Барьера? Парень, тогда мы были там вместе.
	...
	AI_Output(self,other,"DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_04");	//Но сейчас важнее то, что у тебя большие проблемы!
...
func void DIA_1013_BANDIT_DEXTER_Info()
{
	...
	AI_Output(self,other,"DIA_1013_BANDIT_DEXTER_01_03");	//Ох, парень! Хорошо. Его зовут Декстер. Около большой фермы есть крутая скала.
...
func void DIA_1013_BANDIT_PIC_Info()
{
	...
	AI_Output(self,other,"DIA_1013_BANDIT_PIC_01_01");	//Конечно - ведь на ней ТВОЯ рожа.

...
func void DIA_Hakon_Paladine_Info()
{
	...
	AI_Output(self,other,"DIA_Hakon_Add_12_11");	//А взамен, теперь я могу бесплатно жить в отеле - ха!
};
...
func void DIA_Hakon_HaradBandits_Info()
{
	...
	AI_Output(self,other,"DIA_Hakon_Add_12_21");	//Старый добрый Гарад. Возможно, он так хочет сказать мне 'извини', за то, что не может сейчас делать оружие для меня.
};
...
func void DIA_Hakon_Wieviel_Info()
{
	...
	if(Npc_KnowsInfo(other,DIA_Hakon_HaradBandits))
	{
		AI_Output(self,other,"DIA_Hakon_Add_12_25");	//Ты ведь хочешь быть на хорошем счету у Гарада, да?
...
func void DIA_Hakon_Success_Info()
{
	...
	AI_Output(other,self,"DIA_Hakon_Add_15_28");	//Мне что, вернуться назад и отрезать им головы?
	AI_Output(self,other,"DIA_Hakon_Add_12_29");	//Нет - я не думаю, что это необходимо. Я верю тебе.

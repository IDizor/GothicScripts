...
func void DIA_Hokurn_Hello_ASK1()
{
	...
	AI_Output(self,other,"DIA_Hokurn_Hello_ASK1_01_01");	//Ты что, не понял меня? УБИРАЙСЯ!!!
	Info_ClearChoices(DIA_Hokurn_Hello);
	Info_AddChoice(DIA_Hokurn_Hello,Dialog_Ende,DIA_Hokurn_Hello_END);
...
func void DIA_Hokurn_Hello_ASK2()
{
	...
	AI_Output(self,other,"DIA_Hokurn_Hello_ASK2_01_01");	//Ты сам напросился.
	AI_StopProcessInfos(self);
...
{
	AI_Output(self,other,"B_Hokurn_Sauf_01_00");	//Ох, какое блаженство!
...
func void DIA_Hokurn_Question_Info()
{
	...
	AI_Output(self,other,"DIA_Hokurn_Question_01_01");	//Я думал, ты меня понял. Я говорю только с друзьями.

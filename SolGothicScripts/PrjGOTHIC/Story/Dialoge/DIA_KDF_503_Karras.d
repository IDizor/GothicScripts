...
func void DIA_Karras_Hello_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Karras_Hello_10_04");	//Что ты делаешь здесь?
	};
};
...
instance DIA_Karras_CIRCLE4(C_Info)
{
	...
	permanent = TRUE;
	description = "Я хочу изучить четвертый Круг Магии. (5 LP)";
};
...
instance DIA_Karras_CIRCLE5(C_Info)
{
	...
	permanent = TRUE;
	description = "Я хочу изучить пятый Круг Магии. (5 LP)";
};

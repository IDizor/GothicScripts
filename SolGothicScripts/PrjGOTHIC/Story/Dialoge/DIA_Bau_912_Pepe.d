...
func void DIA_Pepe_Hallo_Info()
{
	...
	AI_Output(self,other,"DIA_Pepe_Hallo_03_01");	//Стерегу овец! И, по возможности, стараюсь держаться подальше от неприятностей.
...
func void DIA_Pepe_WhyNotSLD_Info()
{
	...
	AI_Output(self,other,"DIA_Pepe_WhyNotSLD_03_04");	//Я уже пожалел об этом.
};
...
func void DIA_Pepe_KillWolves_Info()
{
	...
	AI_Output(self,other,"DIA_Pepe_KillWolves_03_01");	//Ты, сам? Ха ха. Я не верю в это. Я скорее поверю, что мой баран-вожак расправится с ними.
	...
	AI_Output(self,other,"DIA_Pepe_KillWolves_03_03");	//Подожди минутку. Хорошо, хорошо! Эээ... ты величайший воин, и ты можешь уложить сотню волков одной левой. Нет проблем!
	AI_Output(self,other,"DIA_Pepe_KillWolves_03_04");	//Обычно они шныряют в лесу около пастбища. Я думаю, их всего четверо...
	AI_StopProcessInfos(self);
...
func void DIA_Pepe_KilledWolves_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Pepe_KilledWolves_03_01");	//Ты сделал это! Слава Инносу!
		AI_Output(self,other,"DIA_Pepe_KilledWolves_03_02");	//Но я все равно не знаю, как сказать Онару, что его овцы пропали.
		AI_Output(self,other,"DIA_Pepe_KilledWolves_03_03");	//Это все этот чертов Булко виноват!

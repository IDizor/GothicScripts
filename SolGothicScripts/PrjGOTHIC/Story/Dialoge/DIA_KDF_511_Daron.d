...
func void B_DaronSegen()
{
	...
	{
		B_RaiseAttribute(other,ATR_MANA_MAX,ManaPoints(2));
...
func void DIA_Daron_Spenden_Info()
{
	...
	AI_Output(self,other,"DIA_Daron_Spenden_10_02");	//М-м-м хмм...
...
func void DIA_Addon_Daron_GuildHelp_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Daron_GuildHelp_10_07");	//И не надо на меня так смотреть. Маги, к твоему сведению, тоже люди.

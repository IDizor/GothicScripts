...
func void DIA_Richter_PermissionForShip_Info()
{
	...
	AI_Output(self,other,"DIA_Richter_PermissionForShip_10_01");	//Ты, должно быть, тронулся рассудком. Что ты хочешь, чтобы я сделал?
	...
	AI_Output(self,other,"DIA_Richter_PermissionForShip_10_03");	//Никто не смеет меня шантажировать! Тем более ты! Я скормлю тебя волкам, презренный кусок дерьма!
	...
	AI_Output(self,other,"DIA_Richter_PermissionForShip_10_05");	//Ах-х.

...
func void DIA_Lord_Hagen_Frieden_Info()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_Frieden_04_01");	//Хм... покажи!
	B_UseFakeScroll();
...
func void DIA_Lord_Hagen_Armee_Info()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_Armee_04_05");	//Что это еще за армия?
...
func void DIA_Lord_Hagen_Auge_Info()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_Auge_04_01");	//Это божественный артефакт. В древних пророчествах он упоминается в связи с драконами.
...
func void DIA_Lord_Hagen_Knight_Yes()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_Knight_Yes_04_01");	//Тогда так тому и быть!
...
func void DIA_Lord_Hagen_KAP3U4_PERM_Info()
{
	...
	if(MIS_OLDWORLD == LOG_SUCCESS)
	{
		...
		{
			AI_Output(self,other,"DIA_Lord_Hagen_Add_04_06");	//Возможно, Глаз Инноса может спасти нас всех...
		};
	}
	else
	{
...
{
	if((MIS_RescueBennet == LOG_Running) && ((RecueBennet_KnowsCornelius == FALSE) || (Cornelius_IsLiar == FALSE)))
	{
		return TRUE;
	};
};
...
{
	if((Npc_HasItems(other,ItWr_CorneliusTagebuch_Mis) >= 1) && (Cornelius_IsLiar == TRUE) && (MIS_RescueBennet == LOG_Running) && (RecueBennet_KnowsCornelius == TRUE))
	{
		return TRUE;
	};
};
...
func void DIA_Lord_Hagen_Cornelius_Info()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_Cornelius_04_03");	//Ах, гнусная мразь!
...
func void DIA_Lord_Hagen_AugeAmStart_Info()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_Add_04_11");	//Ты носишь Глаз!
...
func void DIA_Lord_Hagen_AllDragonsDead_Info()
{
	...
	AI_Output(self,other,"DIA_Lord_Hagen_Add_04_20");	//Черт!

...
func void DIA_Addon_Samuel_Versteck_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Samuel_Francis_14_06");	//Фрэнсис ни за что не пустит тебя в хижину, чтобы ты мог покопаться в вещах Грега.
	...
	AI_Output(self,other,"DIA_Addon_Samuel_Francis_14_12");	//Когда капитан вернется и увидит, что что-то из его вещей пропало, он спустит с Фрэнсиса шкуру!
...
func void DIA_Addon_Samuel_Stronger_Info()
{
	...
	if(Samuel_Stronger_Varianz == 0)
	{
		...
		AI_Output(self,other,"DIA_Addon_Samuel_Stronger_14_06");	//Это точно!
...
func void DIA_Addon_Samuel_Stronger_SchnellerHeringX10()
{
	AI_Output(other,self,"DIA_Addon_Samuel_Stronger_SchnellerHering_15_00");	//Дай мне 'Быструю селедку'.
	if(B_GiveInvItems(other,self,ItMi_Gold,300))
	{
		AI_Output(self,other,"DIa_Addon_Samuel_Stronger_SchnellerHering_14_01");	//Злой напиток. Но эффективный!
		B_GiveInvItems(self,other,ItFo_Addon_SchnellerHering,10);
	}
	else
	{
		B_Addon_Samuel_NoGold();
...
{
	AI_Output(other,self,"DIA_Addon_Samuel_Stronger_LousDoubleHammer_15_00");	//Сделай мне двойной 'Молот'.

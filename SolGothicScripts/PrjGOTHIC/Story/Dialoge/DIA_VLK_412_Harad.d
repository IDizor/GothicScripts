...
{
	AI_Output(self,other,"DIA_Harad_Hallo_12_00");	//Что ты хочешь?
};
...
func void DIA_Harad_OrcRunning_TooHard()
{
	...
	AI_Output(self,other,"DIA_Harad_OrcRunning_TooHard_12_04");	//Хм - Хакон, торговец оружием на рыночной площади, сказал мне, что на него напали бандиты несколько дней назад.

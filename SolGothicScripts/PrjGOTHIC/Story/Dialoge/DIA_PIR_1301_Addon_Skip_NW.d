...
func void DIA_Addon_Skip_NW_Hallo_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Skip_NW_Hallo_08_01");	//Минуточку, ты же не торговец из города, верно?
...
func void DIA_Addon_Skip_BaltramPaket_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Skip_BaltramPaket_08_04");	//Ну конечно! Сначала он заставляет меня ждать, потом не приходит на встречу, и у него еще хватает наглости чего-то требовать.

...
func void DIA_Bosper_LEHRLING_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Bosper_LEHRLING_11_01");	//Отлично! Похоже, ты уже знаешь основы.
		stimmen = stimmen + 1;
...
func void DIA_Bosper_ZUSTIMMUNG_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Bosper_ZUSTIMMUNG_11_01");	//Я надеялся, что ты выберешь меня.
	...
	{
		AI_Output(self,other,"DIA_Bosper_ZUSTIMMUNG_11_07");	//Хорошо! Ты получишь мое одобрение - но при одном условии.
...
func void DIA_Bosper_Job_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Bosper_Job_11_05");	//Или ты сможешь стать учеником другого мастера - если ты этого действительно хочешь.
	};
...
func void DIA_Bosper_AlsLehrling_Info()
{
	if((other.guild == GIL_MIL) && (Bosper_StartGuild != GIL_MIL) && (Bosper_MILKommentar == FALSE))
	{
		...
		AI_Output(self,other,"DIA_Bosper_AlsLehrling_11_01");	//Мне, в общем-то, все равно. Лишь бы ты, помимо орков и бандитов, охотился также и на волков.
...
func void DIA_Bosper_SellFur_Info()
{
	...
	if((Npc_HasItems(other,ItAt_SheepFur) > 0) || (Npc_HasItems(other,ItAt_WolfFur) > 0) || (Npc_HasItems(other,ItAt_Addon_KeilerFur) > 0) || (Npc_HasItems(other,ItAt_WargFur) > 0) || (Npc_HasItems(other,ItAt_ShadowFur) > 0) || (Npc_HasItems(other,ItAt_TrollFur) > 0) || (Npc_HasItems(other,ItAt_TrollBlackFur) > 0))
	{

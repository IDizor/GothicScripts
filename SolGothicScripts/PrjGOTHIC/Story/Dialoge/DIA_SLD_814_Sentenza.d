...
func void DIA_Sentenza_Hello_NotYourBusiness()
{
	...
	AI_Output(self,other,"DIA_Sentenza_Hello_NotYourBusiness_09_01");	//Значит, мне придется объяснить тебе это в деталях.
	AI_StopProcessInfos(self);
...
func void DIA_Sentenza_Hello_HandsOff()
{
	...
	AI_Output(self,other,"DIA_Sentenza_Hello_HandsOff_09_01");	//А то что?
	Info_ClearChoices(DIA_Sentenza_Hello);
...
func void DIA_Sentenza_Vzwei_HandsOff()
{
	...
	AI_Output(self,other,"DIA_Sentenza_Vzwei_HandsOff_09_01");	//Да? Похоже, у тебя с собой сейчас побольше золотишка!
	AI_StopProcessInfos(self);
	B_Attack(self,other,AR_NONE,1);
};
...
func void DIA_Sentenza_WannaJoin_Info()
{
	...
	AI_Output(self,other,"DIA_Sentenza_WannaJoin_09_02");	//А ты знаешь, что наемники будут голосовать - принять тебя или нет?
};
...
func void DIA_Sentenza_Vote_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Sentenza_Vote_09_01");	//Только потому, что ты побил меня? Нет.
	}
...
func void DIA_Sentenza_AufsMaul_Info()
{
	...
	AI_Output(self,other,"DIA_Sentenza_AufsMaul_09_01");	//Ладно, ты сам этого хотел...
	AI_StopProcessInfos(self);
	B_Attack(self,other,AR_NONE,1);
};

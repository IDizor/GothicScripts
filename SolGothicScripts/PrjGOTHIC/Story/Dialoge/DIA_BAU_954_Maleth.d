...
func void DIA_Maleth_PROBLEME_schafe()
{
	...
	AI_Output(self,other,"DIA_Maleth_PROBLEME_schafe_08_01");	//Как будто это тебя интересует. У тебя свои проблемы.
...
func void DIA_Maleth_PROBLEME_schafe_probleme()
{
	...
	{
		AI_Output(self,other,"DIA_Maleth_PROBLEME_schafe_probleme_08_01");	//Ты служишь в городской страже или нет? Тогда сделай что-нибудь с этими ублюдками в черных рясах.
	};
	if((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
	{
		AI_Output(self,other,"DIA_Maleth_PROBLEME_schafe_probleme_08_02");	//Вы, грязные наемники, думаете только об одном: как переложить деньги других людей в свои карманы.
	};
...
func void DIA_Maleth_PERM3_Info()
{
	...
	AI_Output(self,other,"DIA_Maleth_PERM3_08_01");	//Проваливай.
	AI_StopProcessInfos(self);
};

...
instance DIA_Franco_PICKPOCKET(C_Info)
{
	...
	permanent = TRUE;
	description = "(Пытаться украсть его амулет очень рискованно)";
};
...
func void DIA_Addon_Franco_While_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Franco_While_08_03");	//А, тебе нужно золото? Ну конечно! Сколько ты хочешь? Пятьдесят самородков? Сто? Я дам тебе столько, сколько ты сможешь унести...
	AI_Output(self,other,"DIA_Addon_Franco_While_08_04");	//Да кто ты такой?! Ты что, хочешь сделать из меня идиота?!
...
{
	AI_Output(other,self,"DIA_Addon_Franco_WOEDGOR_15_00");	//И где же мне найти этого Эдгора?

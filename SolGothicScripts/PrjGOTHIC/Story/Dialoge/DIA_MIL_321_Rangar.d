...
func void DIA_Rangar_Hallo_Info()
{
	...
	AI_Output(self,other,"DIA_Rangar_Hallo_07_01");	//Пока у паладинов нет никаких заданий для меня, я могу расслабиться и попить пивка. А что еще делать?
...
func void DIA_Addon_Rangar_Erwischt_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Rangar_Erwischt_07_01");	//Э-э-э... Я... Это не твое дело! Проваливай!
...
func void DIA_Addon_Rangar_nachhaken_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Rangar_nachhaken_07_01");	//Не поднимай столько шума из-за жалкой кучки хлама.
};

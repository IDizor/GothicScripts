...
func void DIA_Landstreicher_HALLO_wer()
{
	...
	{
		AI_Output(self,other,"DIA_Landstreicher_HALLO_wer_09_03");	//Только посмотри на их дурацкое одеяние. Я бы не хотел быть пойманным на улице ночью в такой одежке.
...
func void DIA_Landstreicher_HALLO_wer_vorsicht()
{
	...
	AI_Output(self,other,"DIA_Landstreicher_HALLO_wer_vorsicht_09_01");	//Ах ты, бедняга. Это объясняет кое-что.

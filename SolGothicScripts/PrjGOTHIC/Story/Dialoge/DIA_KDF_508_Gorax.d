...
func void DIA_Gorax_GOLD_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Gorax_GOLD_14_01");	//Ах! Приношение Инносу. Это очень хорошо, сын мой.
...
func void DIA_Addon_Gorax_DaronsStatue_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Gorax_DaronsStatue_14_01");	//Поистине удивительно то, что такую драгоценность принес в монастырь неопытный послушник.
...
func void DIA_Gorax_KILLPEDRO_Info()
{
	...
	AI_Output(self,other,"DIA_Gorax_KILLPEDRO_14_03");	//В настоящий момент, похоже, все не доверяют друг другу. И к тому же, этот случай с Педро, это очень...

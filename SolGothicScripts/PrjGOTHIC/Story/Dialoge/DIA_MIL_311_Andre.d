...
func void DIA_Andre_Message_Dragons()
{
	...
	AI_Output(self,other,"DIA_Andre_Message_Dragons_08_01");	//Я ЗНАЮ, что армия орков становится все сильнее
...
func void DIA_Addon_Andre_MartinEmpfehlung_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Andre_MartinEmpfehlung_08_01");	//Что? А ну-ка, покажи.
	B_GiveInvItems(other,self,ItWr_Martin_MilizEmpfehlung_Addon,1);
	B_UseFakeScroll();
	AI_Output(self,other,"DIA_Addon_Andre_MartinEmpfehlung_08_02");	//Ну надо же!.. Тебе, должно быть, пришлось потрудиться! Не так-то просто получить нечто подобное от Мартина.
...
func void DIA_Andre_Alternative_Info()
{
	...
	AI_Output(self,other,"DIA_Andre_Alternative_08_01");	//М-м-м. У тебя действительно серьезные намерения, да?

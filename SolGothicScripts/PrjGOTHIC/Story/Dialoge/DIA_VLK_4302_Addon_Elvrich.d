...
func void DIA_Addon_Elvrich_LuciaLetter_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Elvrich_LuciaLetter_04_01");	//Что? Дай его сюда!
	B_UseFakeScroll();
	AI_Output(self,other,"DIA_Addon_Elvrich_LuciaLetter_04_02");	//Нет! Я не верю! Я просто не могу поверить.
	AI_Output(self,other,"DIA_Addon_Elvrich_LuciaLetter_04_03");	//Она не может меня вот так вот бросить.

...
func void DIA_Addon_Lares_Vatras_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_Vatras_09_01");	//Итак, ты уже повидался с Ватрасом. Должно быть, ты произвел на него впечатление.
...
func void DIA_Addon_Lares_WannaBeRanger_AboutYou()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_WannaBeRanger_AboutYou_09_02");	//И у них есть множество причин быть мне благодарными.
};
...
func void DIA_Addon_Lares_Ornament_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_Ornament_09_01");	//Ну конечно! Как всегда, работа достается мне. Я так и знал.
...
func void DIA_Addon_Lares_OrnamentBringJob_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_OrnamentBringJob_09_01");	//Хм-м... Нет, лучше я займусь этим сам. Впрочем, ты можешь пойти со мной.
...
func void DIA_Addon_Lares_BaltramAbloese_Info()
{
	...
	if(SC_IsRanger == FALSE)
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_Lares_BaltramAbloese_09_03");	//Думаю, оно тебе еще поможет.
		}
		else
		{
			AI_Output(self,other,"DIA_Addon_Lares_BaltramAbloese_09_04");	//Кто знает, может, ты решишь стать одним из нас...
		};
	};
...
func void DIA_Addon_Lares_PeopleMissing_Success()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_PeopleMissing_Success_09_01");	//Действительно?
...
func void DIA_Addon_Lares_Gilde_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_09_01");	//Что, устал быть человеком второго сорта?
...
func void DIA_Addon_Lares_Gilde_MIL()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_MIL_09_01");	//Я так понимаю, тебе это понравится. Следить за соблюдением законов, в то же время обчищая кошельки горожан.
...
func void DIA_Addon_Lares_Gilde_KDF()
{
	...
	AI_Output(self,other,"DIA_Addon_Lares_Gilde_KDF_09_01");	//Уверен, Ватрас не предвидел твой выбор. Иначе он бы не послал тебя ко мне.
...
func void DIA_Lares_AboutSld_Sld()
{
	...
	AI_Output(self,other,"DIA_Lares_AboutSld_09_03");	//Если ты проявишь слабость, у тебя не будет шансов присоединиться к ним...
};
...
func void DIA_Lares_WhereGuildOfThieves_Info()
{
	...
	AI_Output(self,other,"DIA_Lares_WhereGuildOfThieves_09_01");	//Не обижайся, но даже если бы знал, не сказал бы.
...
func void DIA_Lares_OtherGuild_Info()
{
	if((other.guild == GIL_MIL) || (other.guild == GIL_PAL))
	{
		if(other.guild == GIL_MIL)
		{
			...
			AI_Output(self,other,"DIA_Lares_OtherGuild_09_01");	//Со смеху помереть можно - бывший каторжник в ополчении...
		}
		else
		{
			AI_Output(self,other,"DIA_Lares_OtherGuild_09_02");	//Так теперь ты один из паладинов короля!
		};
		AI_Output(self,other,"DIA_Lares_OtherGuild_09_03");	//Только ты мог провернуть такое...
		if(Lares_WorkForLee == TRUE)
		{
			AI_Output(self,other,"DIA_Lares_OtherGuild_09_04");	//Ты ведь никому не расскажешь, что я работаю на Ли, правда?
...
{
	AI_Output(self,other,"DIA_Addon_Lares_Albern_09_00");	//Прекрати паясничать! Немедленно отнеси орнамент Сатурасу!
	AI_StopProcessInfos(self);
};
...
func void DIA_Addon_Lares_PortalInterWEITER_Info()
{
	...
	{
		AI_Output(other,self,"DIA_Addon_Lares_PortalInterWEITER_15_01");	//Да, да.
	};
...
func void DIA_Lares_TEACH_BACK()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Lares_TEACH_BACK_Add_09_00");	//Очень хорошо. Ты стал сильнее.
	};
	Info_ClearChoices(DIA_Lares_TEACH);
};

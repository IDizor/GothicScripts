...
func void DIA_Addon_Merdarion_Aufgabe_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Merdarion_Aufgabe_06_04");	//Я даже, пожалуй, никогда не слышал и не читал про нее...
...
func void DIA_Addon_Merdarion_Teleportstein_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Merdarion_Teleportstein_06_02");	//Но ты также можешь... Нет, это слишком опасно.
...
func void DIA_Addon_Merdarion_Teleportstein_key()
{
	...
	AI_Output(self,other,"DIA_Addon_Merdarion_Teleportstein_key_06_01");	//Правда? Но я не отвечаю за последствия.
...
func void DIA_Addon_Merdarion_TeleportsteinSuccess_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Merdarion_TeleportsteinSuccess_06_03");	//Невероятно. Мне нужно будет поближе взглянуть на них.
};

...
func void DIA_Addon_Lucia_Khorinis_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lucia_Khorinis_16_03");	//Но потом... Нет, спасибо. Может быть, это из-за того, что мы на острове... Ладно, в любом случае, с той жизнью покончено.
...
func void DIA_Addon_Lucia_Jetzt_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lucia_Jetzt_16_03");	//Извини... давай вернемся к твоему вопросу... Цели у меня пока нет. Просто плыву по течению.
};
...
func void DIA_Addon_Lucia_lernen_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Lucia_lernen_16_01");	//С радостью. Я могу помочь тебе увеличить ловкость.

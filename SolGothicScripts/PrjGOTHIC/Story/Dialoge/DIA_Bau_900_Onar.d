...
func void DIA_Onar_WegenSekob_Info()
{
	...
	AI_Output(self,other,"DIA_Onar_WegenSekob_14_06");	//Ты безмозглый кретин! Ты что думаешь, он носит деньги с собой? Он их где-то прячет!
...
func void DIA_Onar_CollectGold_Info()
{
	...
	else
	{
		...
		{
			AI_Output(self,other,"DIA_Onar_CollectGold_14_13");	//Ох, ладно. Вот твое жалование.

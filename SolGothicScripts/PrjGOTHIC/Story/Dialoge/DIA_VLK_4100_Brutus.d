...
func void DIA_Brutus_WARUMNICHTARBBEIT_Info()
{
	...
	AI_Output(self,other,"DIA_Brutus_WARUMNICHTARBBEIT_06_01");	//Это ужасно!
...
func void DIA_Brutus_PERM4_Info()
{
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Brutus_PERM4_06_01");	//Ты уверен, что со всеми мясными жуками покончено?
		AI_Output(other,self,"DIA_Brutus_PERM4_15_02");	//Ах... смотри, вон один сзади тебя.
		AI_Output(self,other,"DIA_Brutus_PERM4_06_03");	//Чтооо?
		B_NpcClearObsessionByDMT(self);
...
func void DIA_Brutus_BESSEN_Info()
{
	...
	else
	{
		...
		AI_Output(self,other,"DIA_Brutus_BESSEN_06_04");	//НЕЕТ!
		B_NpcClearObsessionByDMT(self);
		Npc_SetTarget(self,other);
		self.aivar[AIV_INVINCIBLE] = FALSE;
		other.aivar[AIV_INVINCIBLE] = FALSE;

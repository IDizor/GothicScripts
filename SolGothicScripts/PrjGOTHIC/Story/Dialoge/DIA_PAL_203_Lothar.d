...
func void DIA_Lothar_WhoDragons_Info()
{
	...
	if((hero.guild != GIL_PAL) && (hero.guild != GIL_KDF))
	{
		AI_Output(self,other,"DIA_Lothar_WhoDragons_01_02");	//Я предупреждал его - как и тебя! Но этот безумец не переставал действовать мне на нервы!
	};
};
...
func void DIA_Lothar_OWRunning_Info()
{
	...
	AI_Output(self,other,"DIA_Lothar_Add_01_58");	//Ну что ж, тогда удачи. Что за безумец...
	AI_StopProcessInfos(self);
};

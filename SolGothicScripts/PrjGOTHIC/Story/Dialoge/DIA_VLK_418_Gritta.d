...
{
	AI_Output(other,self,"DIA_Gritta_WantsMoney_BeatUp_15_00");	//Выкладывай деньги, или мне придется проучить тебя!
	AI_Output(self,other,"DIA_Gritta_WantsMoney_BeatUp_16_01");	//Да ты просто обычный бандит. Давай, доставая свое оружие, и я позову стражу!

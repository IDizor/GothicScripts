...
func void DIA_Albrecht_TEACHPalRunes_Heal()
{
	...
	if((PLAYER_TALENT_RUNES[SPL_PalLightHeal] == FALSE) && (Kapitel == 3)) //(MIS_ReadyforChapter4 == TRUE))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
	...
	else if((PLAYER_TALENT_RUNES[SPL_PalMediumHeal] == FALSE) && (MIS_ReadyforChapter4 == TRUE)) //(Kapitel >= 5))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
...
func void DIA_Albrecht_TEACHPalRunes_Combat()
{
	...
	if((PLAYER_TALENT_RUNES[SPL_PalHolyBolt] == FALSE) && (Kapitel == 3)) //(MIS_ReadyforChapter4 == TRUE))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
	...
	else if((PLAYER_TALENT_RUNES[SPL_PalRepelEvil] == FALSE) && (MIS_ReadyforChapter4 == TRUE)) //(Kapitel >= 5))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
...
func void DIA_Albrecht_Teach_Info()
{
	...
	Info_AddChoice(DIA_Albrecht_Teach,B_BuildLearnString(B_ManaPlusText(1),B_GetLearnCostAttribute(other,ATR_MANA_MAX)),DIA_Albrecht_Teach_1);
	Info_AddChoice(DIA_Albrecht_Teach,B_BuildLearnString(B_ManaPlusText(5),B_GetLearnCostAttribute(other,ATR_MANA_MAX) * 5),DIA_Albrecht_Teach_5);
};

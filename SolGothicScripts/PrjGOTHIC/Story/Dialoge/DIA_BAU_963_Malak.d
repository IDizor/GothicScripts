...
func void DIA_Malak_Heilung_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Malak_Heilung_08_01");	//Я просто хочу вернуться домой. Я вернусь к Бенгару. Надеюсь, он еще жив.
		B_NpcClearObsessionByDMT(self);
...
func void DIA_Malak_BACKTOBENGAR_Info()
{
	...
	if(MIS_BengarsHelpingSLD == LOG_SUCCESS)
	{
		...
		AI_Output(self,other,"DIA_Malak_BACKTOBENGAR_08_05");	//М-м-м. А может, скажешь, а?

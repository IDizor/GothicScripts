...
func void DIA_Torlof_Probe_Info()
{
	...
	if(Npc_KnowsInfo(other,DIA_Lee_OtherSld))
	{
		...
		AI_Output(self,other,"DIA_Torlof_Probe_01_03");	//Хорошо. Тогда слушай. Прежде чем присоединиться к нам, ты должен сделать две вещи.
...
func void DIA_Torlof_RUF_Info()
{
	...
	else
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_Torlof_RUF_01_00");	//Пусть Корд в этом и поучаствовал...
...
func void DIA_Torlof_BEMYCAPTAIN_Info()
{
	...
	AI_Output(self,other,"DIA_Torlof_BEMYCAPTAIN_01_03");	//До острова? Да у тебя даже нет корабля, не говоря уже о команде.
...
func void DIA_Torlof_LOSFAHREN_Info()
{
	...
	if(B_CaptainConditions(self) == TRUE)
	{
		...
		AI_Output(self,other,"DIA_Torlof_LOSFAHREN_01_02");	//Поднять паруса!

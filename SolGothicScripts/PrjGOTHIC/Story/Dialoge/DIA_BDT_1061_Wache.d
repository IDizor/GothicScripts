...
func void DIA_1061_Wache_Hallo_Info()
{
	...
	AI_Output(self,other,"DIA_1061_Wache_Hallo_01_02");	//Ох, понимаю, ты хочешь поговорить с моим боссом. Что ж, тогда КОНЕЧНО ЖЕ, я позволю тебе пройти.
	AI_Output(self,other,"DIA_1061_Wache_Hallo_01_03");	//Но только если ты назовешь его имя. А если нет, мне придется убить тебя! Хорошо?

...
func void DIA_Addon_Merdarion_ADWHello_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Merdarion_ADWHello_06_01");	//Слушай... Любопытно, да?
...
func void DIA_Addon_Merdarion_ADW_TEACH_MANA_Info()
{
	...
	Info_AddChoice(DIA_Addon_Merdarion_ADW_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(1),B_GetLearnCostAttribute(other,ATR_MANA_MAX)),DIA_Addon_Merdarion_ADW_TEACH_MANA_1);
	Info_AddChoice(DIA_Addon_Merdarion_ADW_TEACH_MANA,B_BuildLearnString(B_ManaPlusText(5),B_GetLearnCostAttribute(other,ATR_MANA_MAX) * 5),DIA_Addon_Merdarion_ADW_TEACH_MANA_5);
};

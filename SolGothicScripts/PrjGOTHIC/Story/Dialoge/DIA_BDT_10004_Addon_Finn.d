...
func void DIA_Addon_Finn_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_BDT_10004_Finn_Hi_07_01");	//Что тебе нужно?
};
...
func void DIA_Addon_Finn_Esteban_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_Esteban_07_01");	//Он здесь босс... он... по-моему, он свой парень.
	AI_Output(self,other,"DIA_Addon_Finn_Esteban_07_02");	//Он всегда отправляет в шахту правильных ребят. Тех, кто знает свое дело, я имею в виду.
};
...
func void DIA_Addon_Finn_Attentat_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_Attentat_07_00");	//Да?
...
{
	AI_Output(self,other,"DIA_Addon_Finn_TellAll_07_00");	//Когда произошло нападение, я собирался забрать свою кирку от кузнеца Хуно.
...
func void DIA_Addon_Finn_Attentat_WannaTalk()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_WannaTalk_07_01");	//Да? И что тебе от него нужно?
	Info_ClearChoices(DIA_Addon_Finn_Attentat);
...
func void DIA_Addon_Finn_Attentat_NoNo()
{
	...
	AI_Output(self,other,"DIA_Addon_Finn_NoNo_07_01");	//Хорошо! Я расскажу тебе то, что я знаю.
	B_Addon_Finn_TellAll();
	Info_ClearChoices(DIA_Addon_Finn_Attentat);
};
...
{
	AI_Output(other,self,"DIA_Addon_Finn_Again_Exit_15_00");	//Ладно...
	Info_ClearChoices(DIA_Addon_Finn_Again);
};

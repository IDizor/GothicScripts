...
func void DIA_Addon_Scatty_Hi_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Scatty_Hi_01_03");	//Рудокопы не слишком усердствуют. А рудокопам, которые не усердствуют, не так много и нужно.
...
func void DIA_Addon_Scatty_GruftAgain_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Scatty_GruftAgain_01_01");	//Хм... ты очень любопытен. Ты напоминаешь мне одного парня, что я когда-то знал.
	...
	AI_Output(self,other,"DIA_Addon_Scatty_GruftAgain_01_06");	//Ладно. Он... он звал... призывал кого-то. Он произносил слова на чужом языке.

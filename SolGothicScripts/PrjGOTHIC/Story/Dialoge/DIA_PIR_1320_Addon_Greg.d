...
{
	AI_Output(self,other,"DIA_Addon_Greg_Hello_01_00");	//Эй, ты! Что ты делаешь в моей хижине?
	AI_Output(other,self,"DIA_Addon_Greg_Hello_15_01");	//Я...
	AI_Output(self,other,"DIA_Addon_Greg_Hello_01_02");	//Стоит уехать на несколько дней, и вот уже каждый проходимец норовит похозяйничать в моем жилище.
	...
	if(!Npc_IsDead(Francis))
	{
		...
		AI_Output(self,other,"DIA_Addon_Greg_ImNew_01_05");	//И это все, что ты сделал, Фрэнсис?
		if(C_BodyStateContains(Francis,BS_SIT))
		{
			AI_Output(self,other,"DIA_Addon_Greg_ImNew_01_06");	//Немедленно слезь с моей скамейки!
		};
	};
...
func void DIA_Addon_Greg_Story_Ship()
{
	...
	AI_Output(self,other,"DIA_Addon_Greg_Story_Ship_01_01");	//Я чертовски удачливый человек. Уже несколько месяцев сюда не приплывали корабли. 

...
func void DIA_Hanna_AusKeller_Info()
{
	if((Cassia.aivar[AIV_KilledByPlayer] == TRUE) || (Jesper.aivar[AIV_KilledByPlayer] == TRUE) || (Ramirez.aivar[AIV_KilledByPlayer] == TRUE))
	{
		...
		AI_Output(self,other,"DIA_Hanna_Add_17_31");	//Я не знаю, чем ты говоришь...
	}
	else
	{
		...
		AI_Output(self,other,"DIA_Hanna_Add_17_21");	//Ха-ха-ха! Я знаю!
...
func void Hanna_Blubb()
{
	...
	AI_Output(self,other,"DIA_Hanna_Add_17_26");	//Я не понимаю, о чем ты говоришь...

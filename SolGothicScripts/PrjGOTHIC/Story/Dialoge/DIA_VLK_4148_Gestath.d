...
func void DIA_Gestath_EXIT_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Gestath_EXIT_09_00");	//Хорошие доспехи!
	};
...
func void DIA_Gestath_HALLO_Info()
{
	...
	AI_Output(self,other,"DIA_Gestath_HALLO_09_01");	//Это мужественный поступок - прийти сюда. А ты не заблудился, часом?
...
func void DIA_Gestath_Drachen_Info()
{
	...
	if(Kapitel < 4)
	{
		AI_Output(self,other,"DIA_Gestath_Drachen_09_01");	//Спроси меня об этом попозже, когда будешь готов к чему-нибудь подобному, хорошо?
	}
	else
	{

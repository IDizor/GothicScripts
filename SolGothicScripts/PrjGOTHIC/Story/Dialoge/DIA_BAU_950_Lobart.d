...
func void DIA_Lobart_STOLENCLOTHS_HereYouGo()
{
	...
	AI_Output(self,other,"DIA_Lobart_STOLENCLOTHS_HereYouGo_05_02");	//А теперь иди работай!
...
func void DIA_Lobart_STOLENCLOTHS_DontHaveIt()
{
	...
	AI_Output(self,other,"DIA_Lobart_STOLENCLOTHS_DontHaveIt_05_01");	//Ты уже продал ее, да? Я проучу тебя, парень!
...
func void DIA_Lobart_STOLENCLOTHS_ForgetIt()
{
	...
	AI_Output(self,other,"DIA_Lobart_STOLENCLOTHS_ForgetIt_05_01");	//Я проучу тебя, парень!
	Lobart_Kleidung_gestohlen = TRUE;
	AI_StopProcessInfos(self);
	B_Attack(self,other,AR_Theft,1);
};
...
func void DIA_Lobart_Hallo_ForTheKing()
{
	...
	AI_Output(self,other,"DIA_Lobart_Hallo_ForTheKing_05_01");	//'За короля!' Также говорили и городские стражники, когда забрали половину моих овец.
...
func void DIA_Lobart_BuyClothes_Info()
{
	...
	Info_AddChoice(DIA_Lobart_BuyClothes,"Давай тогда сюда эту рабочую одежду (Защита: 15/15/0/0)",DIA_Lobart_BuyClothes_BUY);
};
...
func void DIA_Lobart_SldInfo_Info()
{
	...
	AI_Output(self,other,"DIA_Lobart_SldInfo_05_02");	//И чего, спрашивается, от них можно ожидать...
};
...
func void DIA_Lobart_ORKPROBLEM_Info()
{
	...
	AI_Output(self,other,"DIA_Lobart_ORKPROBLEM_05_01");	//Черт. Ну когда-нибудь все это кончится?!

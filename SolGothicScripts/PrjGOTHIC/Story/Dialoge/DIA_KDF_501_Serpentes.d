...
func void DIA_Serpentes_NOTALK_QUESTION()
{
	...
	AI_Output(self,other,"DIA_Serpentes_NOTALK_QUESTION_10_01");	//Похоже, ты не понимаешь. Я решаю, когда говорить с тобой, а когда нет. Что ты о себе вообразил?
...
func void DIA_Serpentes_NOIDEA_Info()
{
	...
	AI_Output(self,other,"DIA_Serpentes_NOIDEA_10_01");	//Я сказал тебе все. Или это испытание кажется тебе слишком сложным?
...
{
	AI_Output(self,other,"DIA_Serpentes_NOHELP_10_00");	//Иди и выполняй свою задачу, послушник!
	AI_StopProcessInfos(self);
};
...
func void DIA_Serpentes_SUCCESS_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Serpentes_SUCCESS_10_02");	//Но ты выдал себя! Это ты убил Гарвига!
	...
	{
		AI_Output(self,other,"DIA_Serpentes_SUCCESS_10_04");	//Тем не менее, я должен признать, что ты выполнил задание, которое я дал тебе.
	};
...
func void DIA_Serpentes_MinenAnteile_Info()
{
	...
	if(hero.guild == GIL_KDF)
	{
		AI_Output(other,self,"DIA_Serpentes_MinenAnteile_15_01");	//Что еще?
...
func void DIA_Serpentes_MinenAnteile_nein()
{
	...
	AI_Output(self,other,"DIA_Serpentes_MinenAnteile_nein_10_01");	//Это возмутительно. Тебе никогда не достичь высших кругов магии, если ты не желаешь выполнять работу для Братства.

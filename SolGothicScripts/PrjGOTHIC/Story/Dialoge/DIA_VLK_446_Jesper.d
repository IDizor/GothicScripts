...
func void DIA_Jesper_Hallo_Umgelegt()
{
	...
	AI_Output(self,other,"DIA_Jesper_Hallo_Umgelegt_09_01");	//Ты убил Аттилу?! А, ладно, он все равно был никчемным псом.
...
func void DIA_Jesper_Hallo_Anfuehrer()
{
	...
	AI_Output(self,other,"DIA_Jesper_Hallo_Anfuehrer_09_01");	//ХА - к главарю? Я уверен, Кассия захочет поговорить с тобой.
...
func void DIA_Jesper_Bogen_Info()
{
	...
	AI_Output(self,other,"DIA_Jesper_Bogen_09_03");	//Ох, да, конечно же, этот сундук заперт. Тебе придется взломать замок. Надеюсь, у тебя есть отмычки.
...
instance DIA_Jesper_Tuer(C_Info)
{
	...
	permanent = FALSE;
	description = "А что за той закрытой дверью?";
};
...
func void DIA_Jesper_Tuer_Info()
{
	...
	AI_Output(self,other,"DIA_Jesper_Tuer_09_01");	//За ней находится сундук - сундук мастера-медвежатника Фингера.

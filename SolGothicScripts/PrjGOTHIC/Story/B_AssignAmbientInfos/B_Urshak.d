...
{
	AI_Output(self,other,"DIA_Urshak_HALLO_18_00");	//КРОТОК ДЖАБАРТ!!!
...
{
	AI_Output(self,other,"DIA_Urshak_HOSHPAKRACHE_18_00");	//КХРОТОК! Я узнавать, что ты быть здесь когда Хош-Пак убивать. Твоя делать большая ошибка, чужак.

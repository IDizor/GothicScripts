...
func void DIA_Skalven_3_STANDARD_Info()
{
	...
	if(randy == 0)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_00");	//Что ты хочешь от меня? Уйди прочь!
	};
	if(randy == 1)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_01");	//Я ничего не делал! Оставь меня.
	};
	if(randy == 2)
	{
		AI_Output(self,other,"DIA_Addon_Sklaven_3_STANDARD_03_02");	//Пожалуйста, не трогай меня!
	};
	AI_StopProcessInfos(self);
};

...
func void B_Video()
{
	...
	AI_Output(self,other,"INTRO_DiegoGorn_12_00");	//Конечно же, он еще жив. А ты как думал?
	...
	AI_Output(other,self,"Extro_Tempel_14_02");	//Не сейчас...
	AI_Output(other,self,"Extro_Tempel_14_03");	//Я готов... выбери меня! Да...
	AI_Output(other,self,"Extro_Tempel_15_04");	//Где же он?
	AI_Output(self,other,"OUTRO_Xardas_14_00");	//И человек убил зверя и вошел в царство Белиара...
	...
	AI_Output(self,other,"Cutscene_Drachen_04_00");	//............Хммм?...........
	AI_Output(self,other,"Cutscene_Drachen_04_01");	//Ох, черт!
	AI_Output(self,other,"Cutscene_Drachen_04_02");	//(задыхается кашляет)
	AI_Output(self,other,"Cutscene_Drachen_04_03");	//Аааааа!
	AI_Output(self,other,"Cutscene_Drachen_04_04");	//(долгий предсмертный крик)
	AI_Output(self,other,"Cutscene_OrcSturm_04_00");	//Закройте ворота!!!
	AI_Output(self,other,"Cutscene_OrcSturm_04_01");	//Остановите их!!!
	AI_Output(self,other,"Cutscene_OrcSturm_04_02");	//Аааааа!
	...
	AI_Output(other,self,"DIA_Addon_AddonIntro_15_00");	// ...люди?
	AI_Output(self,other,"DIA_Addon_AddonIntro_14_01");	//Люди слабы.
	AI_Output(self,other,"DIA_Addon_AddonIntro_14_02");	//Они слишком легко поддаются соблазнам зла.
	...
	AI_Output(self,other,"DIA_Addon_Xardas_AddonIntro_Add_14_02");	//'Когда Бог Тьмы пошлет своих приспешников на поиски...'

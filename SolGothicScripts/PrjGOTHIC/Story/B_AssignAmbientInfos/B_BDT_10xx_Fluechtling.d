...
{
	AI_Output(self,other,"DIA_BDT_1033_Fluechtling_Tip2_07_00");	//Что тебе нужно от меня?
	B_GivePlayerXP(XP_AmbientKap3);
	if(SCFoundMorgahard == FALSE)
	{
...
func void DIA_BDT_1033_Fluechtling_Tip2_Morgahard()
{
	...
	AI_Output(self,other,"DIA_BDT_1033_Fluechtling_Tip2_Morgahard_07_01");	//Мне не нужны проблемы. Иди к лендлорду. Он хотел спрятаться среди наемников. А меня оставь в покое.
	AI_StopProcessInfos(self);
};
...
func void DIA_BDT_1033_Fluechtling_Tip2_Knast()
{
	...
	AI_Output(self,other,"DIA_BDT_1033_Fluechtling_Tip2_Knast_07_01");	//Неет!
	AI_StopProcessInfos(self);
	B_Attack(self,other,AR_SuddenEnemyInferno,1);
};

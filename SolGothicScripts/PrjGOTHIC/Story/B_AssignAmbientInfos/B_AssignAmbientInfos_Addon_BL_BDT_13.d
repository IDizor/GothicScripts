...
func void DIA_Addon_BL_BDT_13_Chef_Info()
{
	...
	if(RavenIsDead == TRUE)
	{
		...
		{
			AI_Output(self,other,"DIA_Addon_BL_BDT_13_Chef_13_01");	//Наш славный командир Торус. Он сделает нас всех богатыми!
		}
		else
		{
	...
	{
		AI_Output(self,other,"DIA_Addon_BL_BDT_13_Chef_13_03");	//Наш славный командир Ворон. Он сделает нас всех богатыми!
	};
};

...
const int STR_Franco = 5;
const int DEX_Franco = 5;
...
const int HP_Amulett_Solo_Bonus = 50;
const int HP_Amulett_EinRing_Bonus = 100;
const int HP_Amulett_Artefakt_Bonus = 200;
const int MA_Ring_Solo_Bonus = 20;
const int MA_Ring_Double_Bonus = 60;
const int MA_Amulett_Solo_Bonus = 50;
const int MA_Amulett_EinRing_Bonus = 100;
const int MA_Amulett_Artefakt_Bonus = 200;
const int STR_Ring_Solo_Bonus = 5;
const int STR_Ring_Double_Bonus = 15;
const int STR_Amulett_Solo_Bonus = 20;
const int STR_Amulett_EinRing_Bonus = 30;

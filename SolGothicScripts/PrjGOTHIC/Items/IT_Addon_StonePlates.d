...
func void Use_StonePlate()
{
	...
	else
	{
		...
		else if(StoneplateItem == ManaStonePlate)
		{
			...
			if(StoneplateLevel == 1)
			{
				B_RaiseAttribute(self,ATR_MANA_MAX,ManaPoints(ManaMax_StPlLevel1));
				Npc_ChangeAttribute(self,ATR_MANA,ManaPoints(ManaMax_StPlLevel1));
				concatText = ConcatStrings(concatText,IntToString(ManaPoints(ManaMax_StPlLevel1)));
				B_Say(self,self,"STONEPLATE_1");
			}
			else if(StoneplateLevel == 2)
			{
				B_RaiseAttribute(self,ATR_MANA_MAX,ManaPoints(ManaMax_StPlLevel2));
				Npc_ChangeAttribute(self,ATR_MANA,ManaPoints(ManaMax_StPlLevel2));
				concatText = ConcatStrings(concatText,IntToString(ManaPoints(ManaMax_StPlLevel2)));
				B_Say(self,self,"STONEPLATE_2");
			}
			else if(StoneplateLevel == 3)
			{
				B_RaiseAttribute(self,ATR_MANA_MAX,ManaPoints(ManaMax_StPlLevel3));
				Npc_ChangeAttribute(self,ATR_MANA,ManaPoints(ManaMax_StPlLevel3));
				concatText = ConcatStrings(concatText,IntToString(ManaPoints(ManaMax_StPlLevel3)));
				B_Say(self,self,"STONEPLATE_3");
			};
		}
...
{
	description = "Каменная табличка жизни I";
...
{
	description = "Каменная табличка жизни II";
...
{
	description = "Каменная табличка жизни III";
...
{
	description = "Каменная табличка лучника I";
...
{
	description = "Каменная табличка лучника II";
...
{
	description = "Каменная табличка лучника III";
...
{
	description = "Каменная табличка арбалетчика I";
...
{
	description = "Каменная табличка арбалетчика II";
...
{
	description = "Каменная табличка арбалетчика III";

...
const int Ri_TProtFire = 4;
const int Ri_TProtEdge = 4;
const int Ri_TProtMage = 4;
const int Ri_TProtPoint = 4;
const int Value_Ri_ProtTotal02 = 1000;
const int Ri_TProtFire02 = 6;
const int Ri_TProtEdge02 = 6;
const int Ri_TProtMage02 = 6;
const int Ri_TProtPoint02 = 6;
const int Value_Ri_Dex = 300;
const int Ri_Dex = 5;
const int Value_Ri_Dex02 = 500;
const int Ri_Dex02 = 10;
const int Value_Ri_Mana = 500;
const int Ri_Mana = 15;
const int Value_Ri_Mana02 = 1000;
const int Ri_Mana02 = 30;
const int Value_Ri_Strg = 300;
const int Ri_Strg = 5;
const int Value_Ri_Strg02 = 500;
const int Ri_Strg02 = 8;
const int Value_Ri_Hp = 200;
const int Ri_Hp = 40;
const int Value_Ri_Hp02 = 400;
const int Ri_Hp02 = 80;
const int Value_Ri_HpMana = 1300;
const int Ri_HpMana_Hp = 50;
const int Ri_HpMana_Mana = 50;

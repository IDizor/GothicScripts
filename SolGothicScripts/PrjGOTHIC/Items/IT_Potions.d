...
instance ItPo_Perm_Mana(C_Item)
{
	...
	count[1] = 0; //ManaMax_Elixier; // commented due to UpdateManaItems() method
	text[5] = NAME_Value;
...
{
	B_RaiseAttribute(self,ATR_MANA_MAX,ManaPoints(ManaMax_Elixier));
	Npc_ChangeAttribute(self,ATR_MANA,ManaPoints(ManaMax_Elixier));
};

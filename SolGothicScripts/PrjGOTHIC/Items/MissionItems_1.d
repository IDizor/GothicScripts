...
instance ItPo_Perm_LittleMana(C_Item)
{
	...
	count[1] = 0; //ManaLittlePotion; // commented due to UpdateManaItems() method
	text[5] = NAME_Value;
	count[5] = value;
};
...
{
	B_RaiseAttribute(self,ATR_MANA_MAX,ManaPoints(ManaLittlePotion));
	Npc_ChangeAttribute(self,ATR_MANA,ManaPoints(ManaLittlePotion));
};

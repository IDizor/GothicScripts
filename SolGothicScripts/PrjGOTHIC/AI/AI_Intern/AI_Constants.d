...
// LEARN переменные чтобы хранить выученные навыки с помощью учителей.
// таким образом использование зелий/скрижалей/растений не повлияет на стоимость обучения у учителей.
const int LEARN_STRENGTH = 91;
const int LEARN_DEXTERITY = 92;
const int LEARN_TALENT_1H = 93;
const int LEARN_TALENT_2H = 94;
const int LEARN_TALENT_BOW = 95;
const int LEARN_TALENT_CROSSBOW = 96;
